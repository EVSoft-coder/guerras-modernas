...
import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, m as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, a as me, z as eventBus, E as Events, B as useToasts, L as Le } from "./app-CJQbhnji.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-R7iF-DvM.js";
import { S as Shield } from "./shield-B0Ao1AFg.js";
import { U as Users } from "./users-CmKqY6qb.js";
import { b as buildingConfigs, g as gameStateService } from "./GameStateService-dq1SsnvL.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-Cz8Ce6Fw.js";
import { B as Button } from "./app-logo-icon-a8EHByiD.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-6O1m1Azb.js";
import { L as LoaderCircle } from "./loader-circle-CL0VeAC_.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-BlFIFfHQ.js";
import { I as Input } from "./index-BFVVfJoX.js";
import { S as Sword } from "./sword-DoZiEuvs.js";
import "./index-D7NoO1di.js";
...
const VillageView = ({ base, onBuildingClick, gameConfig }) => {
  ...
  const buildings = bConfigs.map((b) => {
    const existing = playerBuildings == null ? void 0 : playerBuildings.find((pb) => pb.type === b.id.toLowerCase());
    return {
      ...b,
...
function VillageDashboard({
  ...
  const base = U.useMemo(() => ({
    ...initialBase,
    edificios: globalState.buildings,
  ...
  reactExports.useEffect(() => {
    ...
    PollingService$1.start(() => {
      ...
      Sr.reload({
        ...
        onFinish: () => {
          setTimeout(() => setIsReloading(false), 2e3);
        }
      });
    }, POLL_INTERVAL);
...
//# sourceMappingURL=dashboard-B-Vy3N0N.js.map
