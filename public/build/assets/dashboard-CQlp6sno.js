import { i as isEasingArray, V as VisualElement, a as createBox, b as resolveElements, d as mixNumber, e as removeItem, f as isMotionValue, g as defaultOffset, h as createGeneratorEasing, k as fillOffset, l as isGenerator, s as secondsToMilliseconds, p as progress, n as isSVGElement, o as isSVGSVGElement, q as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, w as animateTarget, x as motionValue, y as spring, c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, r as reactExports, z as motion, X, U, A as AnimatePresence, S as Sr, B as eventBus, E as Events, u as useToasts, C as Logger, L as Le, $ as $e } from "./app-C4MNweow.js";
import { C as ChevronRight, T as TooltipProvider, A as AppLayout } from "./app-layout-B5m4Igr8.js";
import { S as Shield, T as Target } from "./target-B4sIOg6t.js";
import { U as Users } from "./users-D6506vma.js";
import { B as Button, c as cn } from "./app-logo-icon-DsGffiLJ.js";
import { C as Check } from "./index-BE-ykq1t.js";
import { D as Dialog, a as DialogContent, b as DialogTitle, c as DialogFooter } from "./dialog-Bs87aBUb.js";
import { B as Badge, C as Clock, a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-BWhPORaA.js";
import { L as LoaderCircle } from "./loader-circle-CKq6rGUA.js";
import { I as Input } from "./index-C1W3DkzA.js";
import { g as gameStateService } from "./GameStateService-B8TYz8k_.js";
import { S as Search } from "./search-GfdNFBmu.js";
import { C as ChevronLeft } from "./chevron-left-BkbwVzjH.js";
import { S as Sword } from "./sword-CWRvQv4r.js";
import { C as Crosshair } from "./crosshair-CebWUkav.js";
import { G as Globe, B as Book } from "./globe-DXBNgE9w.js";
import { r as resourceSystem } from "./ResourceSystem-dtErqJ-H.js";
...
const CircleCheck = createLucideIcon("CircleCheck", __iconNode$k);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FlaskConical = createLucideIcon("FlaskConical", __iconNode$g);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Hammer = createLucideIcon("Hammer", __iconNode$e);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Maximize2 = createLucideIcon("Maximize2", __iconNode$c);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Move = createLucideIcon("Move", __iconNode$b);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const TransparentImage = ({ src, removeColor, ...props }) => {
  ...
  reactExports.useEffect(() => {
    ...
    img.onload = () => {
      ...
      const targetR = (removeColor == null ? void 0 : removeColor.r) ?? data[0];
      const targetG = (removeColor == null ? void 0 : removeColor.g) ?? data[1];
      const targetB = (removeColor == null ? void 0 : removeColor.b) ?? data[2];
      const tolerance = (removeColor == null ? void 0 : removeColor.tolerance) ?? 30;
  ...
  if (!processedSrc) return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, ...props, style: { ...props.style, opacity: 0 } });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: processedSrc, ...props });
};
const BuildingNode = ({
  type,
  level,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "relative", width: "100%", height: "100%" }, children: !isInvalid ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          TransparentImage,
          {
            src: assetPath,
            alt: type,
            removeColor: { r: 10, g: 12, b: 16, tolerance: 40 },
            style: {
              width: "100%",
              height: "100%",
              objectFit: "contain",
...
const LayoutCalibrator = ({ onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[200] bg-black/95 flex flex-col items-center justify-center p-4 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-7xl bg-[#0a0c10] border border-gray-800 rounded-2xl overflow-hidden shadow-[0_0_100px_rgba(0,0,0,1)] flex flex-col h-[95vh]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 border-b border-gray-800 flex items-center justify-between bg-black/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-bold tracking-[0.2em] uppercase text-base", children: "Calibrador de Layout V3.1 Pro" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-80 border-r border-gray-800 bg-black/20 p-6 flex flex-col gap-8 overflow-y-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[10px] text-gray-600 uppercase font-black tracking-widest", children: "Painel de Controlo" }),
        ...
        selectedBuilding ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in fade-in slide-in-from-left-4 duration-300", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 border-t border-gray-800/50 flex flex-col gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[9px] font-mono text-gray-600 uppercase", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Coord X: ",
              selectedBuilding.x
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-600 font-mono leading-relaxed", children: "SELECIONE UM EDIFÍCIO NO MAPA PARA ATIVAR O PAINEL DE ENGENHARIA" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative bg-[#050608] flex items-center justify-center p-20 overflow-hidden bg-[radial-gradient(#111_1px,transparent_1px)] [background-size:20px_20px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none opacity-20 border border-cyan-500/10" }),
            Object.entries(layout).map(([type, b]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                drag: true,
                dragMomentum: false,
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative w-full h-full transition-transform duration-300 ${selected === type ? "scale-110" : "hover:scale-105"}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    TransparentImage,
                    {
                      ...
                      className: `w-full h-full object-contain pointer-events-none transition-all ${selected === type ? "drop-shadow-[0_0_20px_rgba(6,182,212,0.6)] brightness-125" : "drop-shadow-2xl grayscale-[0.2]"}`,
                      style: {
                  ...
                  selected === type && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 border-2 border-cyan-500/50 rounded-lg animate-pulse" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-8 border border-cyan-500/10 rounded-full pointer-events-none" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute -top-10 left-1/2 -translate-x-1/2 px-3 py-1 rounded border font-mono whitespace-nowrap pointer-events-none transition-all ${selected === type ? "bg-cyan-500 text-black border-cyan-400 font-bold scale-110" : "bg-black/90 text-cyan-400 border-cyan-500/30 text-[9px] opacity-40"}`, children: type.toUpperCase() })
                ] })
              },
              type
            ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-t border-gray-800 bg-black/60 flex items-center justify-between px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-gray-600 uppercase font-bold", children: "Protocolo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-mono italic", children: "ENGINEERING_TOOL_V3.1_PRO" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-gray-600 uppercase font-bold", children: "Unidades" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-400 font-mono italic", children: [
            Object.keys(layout).length,
            " ESTRUTURAS"
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900/50 px-6 py-3 rounded-xl border border-gray-800 text-[11px] text-gray-500 max-w-xl text-right leading-relaxed italic", children: [
        "Clique num edifício para ajustar o seu ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyan-500", children: "tamanho" }),
        " e ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyan-500", children: "orientação" }),
        "."
      ] })
    ] })
  ] }) });
...
const VisualVillageView = ({ base, onBuildingClick, gameConfig, buildingQueue }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "w-full flex flex-col items-center py-6 lg:py-12 bg-[#050608] overflow-hidden", children: [
    ...
    showCalibrator && /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutCalibrator, { onClose: () => setShowCalibrator(false) })
  ] });
};
...
//# sourceMappingURL=dashboard-CQlp6sno.js.map
