import { i as isEasingArray, V as VisualElement, c as createBox, a as resolveElements, b as mixNumber, d as removeItem, e as isMotionValue, f as defaultOffset, g as createGeneratorEasing, h as fillOffset, k as isGenerator, s as secondsToMilliseconds, p as progress, l as isSVGElement, n as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, o as animateSingleValue, q as animateTarget, t as motionValue, u as spring, w as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, x as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, m as me, z as axios, B as useToasts, C as eventBus, E as Events, L as Le } from "./app-YntI9fcX.js";
import { T as Target, C as ChevronRight, M as Map$1, A as AppLayout } from "./app-layout-DQdpA2XE.js";
import { S as Shield } from "./shield-C-VbEXpt.js";
import { U as Users } from "./users-D_Cks3_7.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-CGL4Q7nF.js";
import { B as Button } from "./app-logo-icon-ET5quRIr.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-BuZh_u6y.js";
import { L as LoaderCircle } from "./loader-circle-WykMFOJ7.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-DQt543Xp.js";
import { I as Input } from "./index-DtBz6EVK.js";
import { g as gameStateService } from "./GameStateService-COR0_MXX.js";
import "./index-YCnpx_Pw.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 md:space-y-6 flex-1 overflow-y-auto md:pr-2 custom-scrollbar", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 md:space-y-4", children: isMilitary ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between border-b border-white/10 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-[9px] md:text-[10px] font-black uppercase text-neutral-500 tracking-widest flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 10, "md:size": 12, className: "text-sky-500" }),
...
const StrategyHUD = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 pointer-events-none z-50 flex flex-col justify-between p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start w-full gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1/4 pt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/60 backdrop-blur-md border border-white/5 p-4 rounded-3xl pointer-events-auto shadow-2xl space-y-3", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-6 w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
                  ...
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group cursor-pointer", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `
                                        ...
                                        `, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "-rotate-45", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 18, className: selectedUnit === e.id ? "text-black" : "text-sky-400" }) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedSector && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 p-8 opacity-[0.03]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 200, className: "text-white" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-8 relative z-10 overflow-auto custom-scrollbar pr-2", children: selectedSector.base ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 bg-white/[0.03] rounded-3xl border border-white/5 shadow-inner", children: [
              ...
              ((_c = selectedSector.base.jogador) == null ? void 0 : _c.alianca) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-4 pt-4 border-t border-white/5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 14, className: "text-neutral-600" }),
...
function VillageDashboard({
  ...
  reactExports.useEffect(() => {
    ...
    window.Echo.private(`base.${base.id}`).listen(".BaseUpdated", (e) => {
    ...
    return () => {
      window.Echo.leave(`base.${base.id}`);
      unsubArrived();
      unsubReturned();
      unsubMode();
    };
...
function Dashboard(props) {
  ...
  const SyncIndicator = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-4 right-4 z-50 rounded-full bg-black/80 px-3 py-1 text-[10px] font-mono uppercase tracking-widest text-emerald-500 shadow-lg backdrop-blur-sm border border-emerald-500/20", children: [
...
//# sourceMappingURL=dashboard-hqhpWWjF.js.map
