const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-B5OM_bt7.js","assets/app-DYabfW0d.css"])))=>i.map(i=>d[i]);
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
import { z as eventBus, E as Events, J as Logger, _ as __vitePreload, M as axios } from "./app-B5OM_bt7.js";
import { g as gameStateService, e as entityManager, s as stateManager, G as GameState, a as GameMode } from "./GameStateService-Dj6UcooP.js";
const unitConfigs = {
  infantaria: {
    id: "infantaria",
...
class MarchSystem {
  ...
  createMarch(data) {
    ...
    console.log(`[MARCH] DEPLOYED: Mission ${missionId} for Entity ${entityId}. ETA: ${((travelTimeMs || 5e3) / 1e3).toFixed(1)}s`);
  }
  preUpdate(deltaTime) {
  }
  postUpdate(deltaTime) {
...
class RebelGeneratorSystem {
  ...
  spawnRebel() {
    ...
    const checkVillage = entityManager.getComponent(rebelId, "Village");
    console.log(`VERIFICATION: VillageComponent exists? ${!!checkVillage}, isRebel? ${checkVillage == null ? void 0 : checkVillage.isRebel}`);
    const units = {};
  ...
  async handleBuildingUpgrade(data) {
    ...
    try {
      ...
      const { router } = await __vitePreload(async () => {
        const { router: router2 } = await import("./app-B5OM_bt7.js").then((n) => n.N);
...
//# sourceMappingURL=index-Bw8TaBx7.js.map
