...
class GameStateService {
  ...
  snap() {
    ...
    for (const id of allIds) {
      ...
      const march = entityManager.getComponent(id, "AttackMarch");
      ...
      newSnapshots.push({
        id,
        type: (building == null ? void 0 : building.buildingType) || (unit == null ? void 0 : unit.unitCategory) || (village ? "VILLAGE" : march ? "MARCH" : void 0),
        ...
        resources: res ? { wood: res.wood, stone: res.stone, iron: res.iron } : void 0,
        march: march ? {
          state: march.state,
  ...
  updateGlobalSummary() {
    ...
    const buildingList = buildingEntities.map((id) => {
      ...
      return { type: (b == null ? void 0 : b.buildingType) || "STRUCTURE", level: (b == null ? void 0 : b.level) || 1 };
    });
    this.globalState = {
...
//# sourceMappingURL=GameStateService-COR0_MXX.js.map
