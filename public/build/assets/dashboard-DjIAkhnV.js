import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap$1, m as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, a as me, z as axios, B as useToasts, C as eventBus, E as Events, L as Le } from "./app-CaffU5yp.js";
import { T as Target$1, C as ChevronRight, A as AppLayout } from "./app-layout-CgbiZP6-.js";
import { S as Shield$1 } from "./shield-DrAQLHNl.js";
import { U as Users } from "./users-DwpK5mLR.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-C9EU_3bo.js";
import { B as Button } from "./app-logo-icon-Cez9oZi1.js";
import { B as Badge, C as Clock, S as Search, a as Crosshair$1, A as AttackModal } from "./AttackModal-XVofHLgm.js";
import { L as LoaderCircle } from "./loader-circle-1twWVrpg.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-D9TPq0xc.js";
import { I as Input } from "./index-BmaxG_cx.js";
import { g as gameStateService } from "./GameStateService-BnLdnFtm.js";
import "./index-BEwXNxFN.js";
import "./sword-DB6kOqdw.js";
...
const TrendingUp = createLucideIcon("TrendingUp", __iconNode$1);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const ResourceBar = ({ recursos, taxasPerSecond }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-6 gap-4 w-full z-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ResourceItem,
      {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield$1, { className: "text-sky-400 drop-shadow-[0_0_12px_rgba(56,189,248,0.5)]", size: 24 }),
        label: "Suprimentos",
        value: current.suprimentos,
        rate: ((taxasPerSecond == null ? void 0 : taxasPerSecond.suprimentos) ?? 0) * 3600,
        color: "text-white",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ResourceItem,
      {
        ...
        rate: ((taxasPerSecond == null ? void 0 : taxasPerSecond.combustivel) ?? 0) * 3600,
        color: "text-white",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ResourceItem,
      {
        ...
        label: "Metal",
        value: current.metal,
        rate: ((taxasPerSecond == null ? void 0 : taxasPerSecond.metal) ?? 0) * 3600,
        color: "text-white",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ResourceItem,
      {
        ...
        rate: ((taxasPerSecond == null ? void 0 : taxasPerSecond.municoes) ?? 0) * 3600,
        color: "text-white",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ResourceItem,
      {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap$1, { className: "text-yellow-400 drop-shadow-[0_0_12px_rgba(250,204,21,0.5)]", size: 24 }),
        label: "Energia",
        value: current.energia,
        rate: ((taxasPerSecond == null ? void 0 : taxasPerSecond.energia) ?? 0) * 3600,
        color: "text-white",
...
const ResourceItem = ({ icon, label, value, rate, color, accentColor, isStatic = false }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center bg-black/40 backdrop-blur-3xl p-6 rounded-[2.5rem] border border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.6)] group cursor-help transition-all duration-500 hover:bg-white/[0.05] hover:border-white/10 relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-24 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-500 z-50 pointer-events-none scale-90 group-hover:scale-100 translate-y-4 group-hover:translate-y-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-neutral-900 border border-white/10 px-5 py-4 rounded-3xl shadow-[0_40px_80px_rgba(0,0,0,1)] flex flex-col items-center min-w-[200px]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8px] text-neutral-500 font-mono uppercase tracking-tighter text-center leading-relaxed", children: "Monitorização em tempo real de fluxos e reservas estratégicas" })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: !isStatic ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/[0.03] border border-white/5 opacity-50 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-black text-neutral-400", children: [
      Math.floor(rate).toLocaleString(),
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] opacity-40", children: "/H" })
...
const BuildingNode = ({ tipo, nome, nivel, gridPos, isConstructing, onClick }) => {
  var _a, _b;
  const [currentTryLevel, setCurrentTryLevel] = reactExports.useState(getEvolutionLevelAsset(nivel ?? 1));
  const imgUrl = `/images/edificios/${(tipo == null ? void 0 : tipo.toLowerCase()) ?? "base"}/lvl_${currentTryLevel ?? 1}.png`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      style: {
        gridArea: `${((gridPos == null ? void 0 : gridPos.y) ?? 0) + 1} / ${((gridPos == null ? void 0 : gridPos.x) ?? 0) + 1} / span 1 / span 1`
      },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group/bldg transition-all duration-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-sky-500/0 group-hover:bg-sky-500/10 blur-xl rounded-full transition-all duration-300" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.img,
            {
              src: imgUrl,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-1 -right-1 bg-neutral-950 border border-sky-500/40 rounded-md px-1.5 py-0.5 shadow-xl backdrop-blur-md z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-mono font-black text-white", children: nivel ?? 0 }) }),
          isConstructing && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full border-2 border-orange-500 border-t-transparent rounded-full animate-spin opacity-60" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 flex flex-col items-center bg-black/40 px-2 py-0.5 rounded border border-white/5 backdrop-blur-sm opacity-60 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] font-black uppercase text-neutral-300 tracking-tighter whitespace-nowrap", children: ((_b = (_a = nome == null ? void 0 : nome.split) == null ? void 0 : _a.call(nome, " / ")) == null ? void 0 : _b[0]) ?? "UNKNOWN" }) })
      ]
    }
  );
};
const VillageView = ({ base, onBuildingClick, gameConfig }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full aspect-video bg-black rounded-[2.5rem] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.9)] border border-white/5 group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-2 z-20 grid grid-cols-5 grid-rows-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        BuildingNode,
        {
          tipo: "qg",
          ...
          nivel: base.qg_nivel,
          gridPos: { x: 2, y: 2 },
          onClick: () => onBuildingClick({ tipo: "qg", nome: "Quartel General", nivel: base.qg_nivel, base })
        }
      ),
      (base.edificios || []).filter((b) => {
        var _a, _b;
        return ((_a = b.tipo) == null ? void 0 : _a.toLowerCase()) !== "qg" && ((_b = b.tipo) == null ? void 0 : _b.toLowerCase()) !== "muralha";
      }).map((b) => {
        var _a;
        const tipoNormalizado = (_a = b.tipo) == null ? void 0 : _a.toLowerCase();
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          BuildingNode,
          {
            ...
            nivel: b.nivel,
            gridPos: pos,
            onClick: () => onBuildingClick({ ...b, id: b.id, nome: buildingDisplayNames[tipoNormalizado] || b.tipo, base })
          },
          b.id
        );
      })
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 relative bg-gradient-to-br from-neutral-900 to-black p-6 md:p-8 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-white/10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "absolute top-6 left-6 bg-sky-500/10 text-sky-400 border-sky-500/20 font-black px-4 py-1.5 rounded-full text-[10px] tracking-widest uppercase flex items-center gap-2 shadow-2xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 bg-sky-400 rounded-full animate-pulse" }),
              "STATUS: OPERACIONAL"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 p-6 md:p-8 flex flex-col bg-neutral-900/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { className: "mb-4 md:mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-sky-500 font-bold uppercase tracking-widest flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Shield$1, { size: 10 }),
                " Setor de ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 md:space-y-6 flex-1 overflow-y-auto md:pr-2 custom-scrollbar", children: [
              ...
              currentBonus && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 md:gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-sky-600/10 p-3 md:p-4 rounded-xl md:rounded-2xl border border-sky-500/30 space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm md:text-xl font-mono font-black text-sky-400 flex items-center gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 14, "md:size": 16 }),
                    " ",
              ...
              !currentBonus && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-3 md:gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-orange-600/10 p-4 rounded-2xl border border-orange-500/20 flex items-center justify-between", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Zap$1, { className: "text-orange-500", size: 24 })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 md:space-y-4", children: isMilitary ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between border-b border-white/10 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-[9px] md:text-[10px] font-black uppercase text-neutral-500 tracking-widest flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Shield$1, { size: 10, "md:size": 12, className: "text-sky-500" }),
                ...
                selectedUnit && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/40 p-4 rounded-xl space-y-3 border border-white/5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      ...
                      children: [
                        isTraining ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Target$1, { size: 14 }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-white/10 pb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-[9px] md:text-[10px] font-black uppercase text-neutral-500 tracking-widest flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Hammer, { size: 10, "md:size": 12, className: "text-orange-500" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[9px] md:text-[10px] font-black text-orange-500 uppercase font-mono", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 10, "md:size": 12 }),
                    " ",
                    timeFormatted
                  ] })
                ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { className: "mt-6 md:mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                className: `w-full font-black uppercase tracking-[0.15em] md:tracking-[0.2em] py-6 md:py-8 rounded-xl md:rounded-2xl flex items-center justify-center gap-2 md:gap-3 group transition-all shadow-2xl ${canAfford ? "bg-sky-600 hover:bg-sky-500 text-white border-t border-white/20 shadow-sky-900/40" : "bg-neutral-800 text-neutral-500 cursor-not-allowed border-none"}`,
                children: [
                  ...
                  !isUpgrading && canAfford && /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "group-hover:translate-x-2 transition-transform", size: 16, "md:size": 20 }),
                  !canAfford && !isUpgrading && /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 16 })
                ]
              }
            ) })
          ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-black/20 border-white/5 backdrop-blur-3xl overflow-hidden shadow-2xl rounded-[1.5rem] relative group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "py-6 min-h-[150px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[8px] font-black uppercase text-neutral-500", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Shield$1, { size: 10, className: "text-emerald-600" }),
                  "Potencial Defensivo: ",
      ...
      (!tropas || tropas.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-1 py-12 text-center border border-dashed border-white/5 rounded-2xl bg-white/[0.01]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Target$1, { className: "mx-auto text-neutral-800 mb-3 opacity-20", size: 32 }),
...
const ArmyMovementPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-black/20 border-white/5 backdrop-blur-3xl overflow-hidden mb-8 rounded-[1.5rem] shadow-2xl relative group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "py-4 bg-red-500/[0.03] border-b border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-[10px] uppercase font-black tracking-[0.25em] text-red-500/80 flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Zap$1, { className: "animate-pulse", size: 16 }),
...
const ActiveMovements = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-auto space-y-3 mt-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Target$1, { size: 12, className: "text-red-500 animate-pulse" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-black/40 backdrop-blur-md border border-white/5 p-4 rounded-3xl shadow-2xl space-y-3 max-h-[300px] overflow-y-auto custom-scrollbar", children: movements.map((m) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-neutral-900/40 border border-white/5 p-3 rounded-2xl space-y-2 group transition-all hover:border-white/10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-[8px] font-black px-1.5 py-0.5 rounded-full ${m.status === "returning" ? "bg-sky-500/20 text-sky-400" : "bg-red-500/20 text-red-500"}`, children: ((_a = m.status) == null ? void 0 : _a.toUpperCase()) || "TRANSIT" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-neutral-500", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] font-mono tracking-tighter", children: [
            "GPS: ",
            (_b = m.march) == null ? void 0 : _b.target.x,
            ":",
            (_c = m.march) == null ? void 0 : _c.target.y
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-neutral-400", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono font-bold tracking-widest text-white", children: [
              Math.max(0, Math.floor(((_d = m.march) == null ? void 0 : _d.remainingTime) || 0)),
              "s"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1 bg-white/5 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              initial: { width: 0 },
              animate: { width: `${Math.min(100, (1 - ((_e = m.march) == null ? void 0 : _e.remainingTime) / ((_f = m.march) == null ? void 0 : _f.totalTime)) * 100)}%` },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start w-full gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-1/4 pt-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/60 backdrop-blur-md border border-white/5 p-4 rounded-3xl pointer-events-auto shadow-2xl space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapIcon, { size: 12, className: "text-sky-500" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pointer-events-auto bg-black/40 backdrop-blur-xl border border-white/5 p-1.5 rounded-3xl shadow-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceNode, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { size: 14 }), label: "WOOD", value: resources.wood, color: "text-amber-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceNode, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 14 }), label: "STONE", value: resources.stone, color: "text-slate-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceNode, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 14 }), label: "IRON", value: resources.iron, color: "text-sky-400" })
      ] }),
...
function WorldMapView({ playerBase, troops = [], gameConfig }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-6 w-full animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-neutral-950 rounded-[2.5rem] border border-white/5 overflow-hidden shadow-2xl relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-6 left-6 z-20 flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl p-1 flex items-center shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "bg-black/80 backdrop-blur-xl border-white/10 rounded-2xl text-[10px] font-black uppercase", onClick: jumpToPlayer, children: [
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                Array.from({ length: 20 }).map((_, y) => Array.from({ length: 20 }).map((_2, x) => {
                  var _a2, _b2;
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `absolute border border-white/[0.03] transition-all duration-1000 cursor-crosshair group/cell ${((_a2 = globalState.revealedTiles) == null ? void 0 : _a2.includes(`${x},${y}`)) ? "opacity-100 bg-sky-500/[0.02]" : "opacity-20 grayscale brightness-50"}`,
                      onClick: () => {
                        setSelectedSector({ x, y, base: visibleBases.find((b) => b.coordenada_x === x && b.coordenada_y === y) });
                        if (selectedUnit) {
                          window.eventBus.emit("UNIT:MOVE", {
                            timestamp: Date.now(),
                      ...
                      children: ((_b2 = globalState.revealedTiles) == null ? void 0 : _b2.includes(`${x},${y}`)) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute top-1 left-1 text-[8px] text-neutral-800 font-mono group-hover/cell:text-neutral-500", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none z-30", children: gameEntities.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    initial: { opacity: 0 },
                    animate: { opacity: 1 },
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group cursor-pointer", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `
                                        ...
                                        `, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "-rotate-45", children: e.type === "Army" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Navigation,
                        {
                          size: 18,
                          className: `${selectedUnit === e.id ? "text-black" : "text-orange-400"} ${e.status === "returning" ? "rotate-180" : ""} transition-transform`
                        }
                      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Target$1, { size: 18, className: selectedUnit === e.id ? "text-black" : "text-sky-400" }) }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-black/80 px-2 py-0.5 rounded border border-white/5 opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] text-white font-black uppercase whitespace-nowrap tracking-widest", children: e.type || "STRIKER_V1" }) })
                    ] })
                  },
                  `entity-${e.id}`
                )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedSector && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 p-8 opacity-[0.03]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Target$1, { size: 200, className: "text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-8 relative z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-red-500 animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black text-red-500 uppercase tracking-[0.4em]", children: "Sector_Inteligence" })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-neutral-500 font-mono text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Crosshair$1, { size: 14 }),
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sky-500", children: [
                "[",
                selectedSector.x.toString().padStart(3, "0"),
                ":",
                selectedSector.y.toString().padStart(3, "0"),
                "]"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-8 relative z-10 overflow-auto custom-scrollbar pr-2", children: selectedSector.base ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 bg-white/[0.03] rounded-3xl border border-white/5 shadow-inner", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-sky-500/10 rounded-2xl flex items-center justify-center border border-sky-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 20, className: "text-sky-400" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-black text-white tracking-tight", children: (_b = selectedSector.base.jogador) == null ? void 0 : _b.username })
                ] })
              ] }),
              ((_c = selectedSector.base.jogador) == null ? void 0 : _c.alianca) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-4 pt-4 border-t border-white/5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Shield$1, { size: 14, className: "text-neutral-600" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-black text-sky-400 uppercase tracking-tighter", children: [
                  "Allied_Command: ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-red-500/5 rounded-2xl border border-red-500/10 group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-neutral-600 uppercase font-black block mb-2", children: "Defense_Protocols" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-red-500 group-hover:scale-105 transition-transform", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Shield$1, { size: 14 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black text-xs", children: "HARDENED" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-emerald-500/5 rounded-2xl border border-emerald-500/10 group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-neutral-600 uppercase font-black block mb-2", children: "Resource_Yield" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-emerald-500 group-hover:scale-105 transition-transform", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Zap$1, { size: 14 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black text-xs", children: "HARVESTABLE" })
                ] })
              ] })
            ] }),
            ((_d = selectedSector.base.jogador) == null ? void 0 : _d.id) !== (playerBase == null ? void 0 : playerBase.jogador_id) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative p-6 bg-white/[0.02] rounded-3xl border border-dashed border-white/10 group hover:border-sky-500/30 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-neutral-500 font-medium leading-relaxed uppercase tracking-tight", children: "Neutral Sector detected. Zero structural signals found. Military control recommended for territorial integrity." }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: "ABORT_INTEL_SCAN"
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-8 pt-6 border-t border-white/5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-mono text-neutral-700 tracking-[0.5em]", children: "SYSTEMS_STABLE_V3.9.2" }) })
        ]
      }
    ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 flex-1 relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-black uppercase tracking-tighter text-white flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Target$1, { className: "text-orange-500 animate-pulse", size: 28 }),
              "CENTRAL: ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-4 flex flex-col gap-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-black/20 border-white/5 backdrop-blur-3xl overflow-hidden shadow-2xl rounded-[1.5rem] relative group", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "py-4 bg-white/[0.02] border-b border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-[10px] uppercase font-black tracking-[0.25em] text-neutral-400 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Target$1, { className: "text-orange-500", size: 16 }),
...
function Dashboard(props) {
  ...
  const { entities } = useGameEntities() || { entities: [] };
  const hasActiveArmy = (entities == null ? void 0 : entities.some((e) => e.march)) ?? false;
  ...
  reactExports.useEffect(() => {
    let delay = gameMode === "WORLD_MAP" ? 5e3 : 1e4;
    if (hasActiveArmy) {
      delay = 3e3;
    }
...
//# sourceMappingURL=dashboard-DjIAkhnV.js.map
