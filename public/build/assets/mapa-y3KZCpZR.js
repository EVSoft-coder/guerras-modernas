import { c as createLucideIcon, B as useToasts, U, z as eventBus, E as Events, y as Sr, j as jsxRuntimeExports, L as Le, $ as $e } from "./app-54PfkRw8.js";
import { A as AppLayout, M as Map, C as ChevronRight, T as Target } from "./app-layout-CMLujuhA.js";
import { S as Search, a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-CaRAh1Xa.js";
...
import "./app-logo-icon-Jbo25-38.js";
import "./index-DQ-BTb4l.js";
import "./index-GWYQGqHH.js";
import "./dialog-CY1UtoVL.js";
import "./shield-DCcJ3iXD.js";
import "./sword-DmLDeb71.js";
import "./loader-circle-DYtqtl5w.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col gap-6 p-6 bg-neutral-900 text-white min-h-screen", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-1 bg-black/20 p-2 rounded-xl border border-white/10 shadow-2xl overflow-auto max-w-full max-h-[70vh]", children: grid.map((row, rowIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: row.map((cell, cellIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          onClick: () => {
            if (cell.base && cell.base.ownerId === (origemBase == null ? void 0 : origemBase.ownerId)) return;
          ...
          className: `w-12 h-12 md:w-16 md:h-16 border rounded flex flex-col items-center justify-center relative transition-all duration-300 group cursor-pointer
                                            ${cell.base ? cell.base.ownerId === (origemBase == null ? void 0 : origemBase.ownerId) ? "bg-green-500/20 border-green-500/40 hover:bg-green-500/40" : "bg-red-500/10 border-red-500/40 hover:bg-red-500/30 hover:shadow-[0_0_15px_rgba(239,68,68,0.2)]" : "bg-white/5 border-white/5 hover:border-white/20"}
          ...
          children: [
            ...
            cell.base ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1 group-hover:scale-110 transition-transform", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { size: 16, className: cell.base.ownerId === 1 ? "text-green-500" : "text-red-500" }),
...
//# sourceMappingURL=mapa-y3KZCpZR.js.map
