import { K, r as reactExports, j as jsxRuntimeExports, L as Le, $ as $e } from "./app-DhEBV9GP.js";
function Welcome() {
  var _a;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Le, { title: "Welcome", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("link", { rel: "preconnect", href: "https://fonts.bunny.net" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("link", { href: "https://fonts.bunny.net/css?family=instrument-sans:400,500,600", rel: "stylesheet" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center justify-end gap-4", children: (auth == null ? void 0 : auth.user) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        $e,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mb-1 font-medium", children: "Let's get started" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-2 text-[#706f6c] dark:text-[#A1A09A]", children: [
            "Laravel has an incredibly rich ecosystem.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "We suggest you start with the following."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mb-4 flex flex-col lg:mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative bg-white py-1 dark:bg-[#161615]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" }) }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative bg-white py-1 dark:bg-[#161615]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    className: "ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Laracasts" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          width: 10,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex gap-3 text-sm leading-normal", children: /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              ...
              xmlns: "http://www.w3.org/2000/svg",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M17.2036 -3H0V102.197H49.5189V86.7187H17.2036V-3Z", fill: "currentColor" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "path",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M438 -3H421.694V102.197H438V-3Z", fill: "currentColor" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M139.43 102.197H155.735V48.2834H183.712V32.1665H139.43V102.197Z", fill: "currentColor" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "path",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              ...
              xmlns: "http://www.w3.org/2000/svg",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { className: "translate-y-0 opacity-100 transition-all delay-300 duration-750 starting:translate-y-4 starting:opacity-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "path",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-t-none lg:rounded-r-lg dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden h-14.5 lg:block" })
    ] })
  ] });
}
export {
...
//# sourceMappingURL=welcome-BhAbdmwu.js.map
