...
import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, m as motion, U, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, a as me, z as eventBus, E as Events, B as useToasts, L as Le } from "./app-C-5dJbtT.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-N3rrymUt.js";
import { S as Shield } from "./shield-CQeNk4vQ.js";
import { U as Users } from "./users-CpZFtPVA.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-C_JpQX4z.js";
import { B as Button } from "./app-logo-icon-DtPjyi0B.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-D4QzzwRP.js";
import { L as LoaderCircle } from "./loader-circle-DJefC57J.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-sQo5TgGS.js";
import { I as Input } from "./index-Cj5rbllx.js";
import { g as gameStateService } from "./GameStateService-YTwzM3wW.js";
import { S as Sword } from "./sword-CqMPvYhb.js";
import "./index-COIWOwlJ.js";
...
const BuildingNode = ({ tipo, nome, nivel, gridPos, isConstructing, isLocked, onClick }) => {
  ...
  const playerBuildings = U.useMemo(() => {
    ...
    const list = [
      ...
      ...((_a = base.edificios) == null ? void 0 : _a.filter((eb) => {
        var _a2;
        const t = (_a2 = eb.tipo) == null ? void 0 : _a2.toLowerCase();
        return t !== "qg" && t !== "muralha";
      }).map((eb) => {
        var _a2;
        let type = (_a2 = eb.tipo) == null ? void 0 : _a2.toLowerCase();
...
function VillageDashboard({
  ...
  const base = U.useMemo(() => {
    ...
    return {
      ...initialBase,
      edificios: initialBase.edificios || [],
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-1 flex-col gap-10 p-8 bg-neutral-950 text-white min-h-screen relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceBar, { recursos: (base == null ? void 0 : base.recursos) ?? {}, taxasPerSecond: taxasPerSecond ?? {}, populacao }),
...
//# sourceMappingURL=dashboard-IeCk2-hX.js.map
