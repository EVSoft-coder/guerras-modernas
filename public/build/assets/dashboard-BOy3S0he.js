...
import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, m as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, a as me, z as useToasts, B as eventBus$1, E as Events$1, L as Le } from "./app-0rOCMP1q.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-DNJw2TtV.js";
import { S as Shield } from "./shield-DfkPlpqI.js";
import { U as Users } from "./users-BgweSOWz.js";
import { G as GLOBAL_BUILDINGS, g as gameStateService } from "./GameStateService-POWb3UyN.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-DavvKELN.js";
import { B as Button } from "./app-logo-icon-BazrP3Bf.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-DBdiVq5G.js";
import { L as LoaderCircle } from "./loader-circle-DiY4wUe5.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-CY2VG34-.js";
import { I as Input } from "./index-wPtDqjOu.js";
import { S as Sword } from "./sword-B4U9Yt79.js";
import "./index-Bn_Vu0wC.js";
...
function VillageDashboard({
  ...
  reactExports.useEffect(() => {
    if (!base) return;
    if (ataquesEnviados) eventBus$1.emit(Events$1.LARAVEL_SYNC_ATTACKS, { data: { attacks: ataquesEnviados } });
    if (ataquesRecebidos) eventBus$1.emit(Events$1.LARAVEL_SYNC_ATTACKS, { data: { attacks: ataquesRecebidos } });
    const unsubArrived = eventBus$1.subscribe(Events$1.ATTACK_ARRIVED, (ev) => {
      const res = ev.data.result === "VICTORY" ? "VITÓRIA" : "OPERACIONAL";
      addToast(`MISSÃO: Força de ataque atingiu o alvo com ${res}.`, "success");
    });
    const unsubReturned = eventBus$1.subscribe(Events$1.ATTACK_RETURNED, (ev) => {
      addToast(`LOGÍSTICA: Coluna militar regressou à base. Saque capturado.`, "info");
      Sr.reload({ only: ["base"] });
    });
    const unsubMode = eventBus$1.subscribe(Events$1.GAME_CHANGE_MODE, (ev) => {
  ...
  const handleUpgrade = (tipo) => {
    eventBus$1.emit(Events$1.BUILDING_UPGRADE_REQUEST, {
      base_id: base.id,
      tipo
    });
  ...
  const handleTrain = (unidade, quantidade) => {
    eventBus$1.emit(Events$1.UNIT_TRAIN_REQUEST, {
      base_id: base.id,
      unidade,
      quantidade
    });
...
//# sourceMappingURL=dashboard-BOy3S0he.js.map
