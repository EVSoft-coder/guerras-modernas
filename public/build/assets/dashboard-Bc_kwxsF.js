...
import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, m as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, a as me, z as useToasts, B as eventBus, E as Events, L as Le } from "./app-DgFLyAXp.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-DcXTVohw.js";
import { S as Shield } from "./shield-CePdhsqQ.js";
import { U as Users } from "./users-D1XPIN0Q.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-CYh6MS-U.js";
import { B as Button } from "./app-logo-icon-Ckdgjl3W.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-D80ti3v8.js";
import { L as LoaderCircle } from "./loader-circle-DUUfLzAn.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-DpY1BfK9.js";
import { I as Input } from "./index-DF7L8gie.js";
import { g as gameStateService } from "./GameStateService-CLb50sew.js";
import { S as Sword } from "./sword-cl3RgB0N.js";
import "./index-CbRyRZaZ.js";
...
function WorldMapView({ playerBase, troops = [], gameConfig }) {
  ...
  const visibleBases = reactExports.useMemo(() => {
    return gameEntities.filter((e) => e.type === "VILLAGE").map((e) => ({
      id: e.id,
      ...
      jogador: e.ownerId ? {
        id: e.ownerId,
        username: e.ownerId === (playerBase == null ? void 0 : playerBase.jogador_id) ? "VOCÊ" : `COMANDANTE_${e.ownerId}`
      } : void 0
    }));
...
//# sourceMappingURL=dashboard-Bc_kwxsF.js.map
