...
import { C as eventBus, E as Events } from "./app-DeScd2lX.js";
import { g as gameStateService, e as entityManager, G as GameState, s as stateManager, a as GameMode } from "./GameStateService-CT9bQBxS.js";
class Logger {
  static info(message) {
...
const unitStats = {
  ...
  "politico": { name: "Comissário Político", speed: 5, attack: 1, defense: 2, capacity: 0, isSpecial: true, canConquer: true }
};
class CombatSystem {
  init() {
...
class AttackSystem {
    ...
    if (originId) {
      ...
      if (village) {
        for (const [res, qty] of Object.entries(march.loot || {})) {
          if (village.resources[res] !== void 0) {
  ...
  launchAttack(data) {
    ...
    const travelTimeMs = distance / slowestSpeed * (3600 / travelMultiplier) * 1e3;
...
//# sourceMappingURL=index-DA3slFrk.js.map
