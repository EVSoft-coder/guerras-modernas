import { c as createLucideIcon, K, j as jsxRuntimeExports, L as Le, $ as $e, Z as Zap, I as Info, S as Sr } from "./app-DH1jw8uF.js";
import { A as AppLayout } from "./app-layout-D6dt3p2z.js";
import { C as ChevronLeft } from "./chevron-left-Ct4LasXq.js";
import { S as Share2, a as Skull } from "./skull-hCZFDLmt.js";
import { S as Sword } from "./sword-C4LOyN37.js";
import { T as Trophy } from "./trophy-D20x5p10.js";
import { C as Calendar } from "./calendar-CnMNNyGS.js";
import { C as ChartColumn } from "./chart-column-DvwgxvKL.js";
import { T as TrendingUp } from "./trending-up-BKi1-qXm.js";
import { S as Shield } from "./target-IB-qeveT.js";
...
function Show({ relatorio }) {
  var _a, _b, _c;
  const { auth } = K().props;
  const isAtacante = relatorio.atacante_id === ((_a = auth.user) == null ? void 0 : _a.id);
  const isVitoria = relatorio.vencedor_id === ((_b = auth.user) == null ? void 0 : _b.id);
  const canShare = isAtacante || relatorio.defensor_id === ((_c = auth.user) == null ? void 0 : _c.id);
          ...
          canShare && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                " ",
                relatorio.partilhado_alianca ? "Partilhado" : "Partilhar"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            $e,
            {
              ...
              children: [
                ...
                " ",
                isAtacante ? "Atacar Novamente" : "Lançar Contra-Ataque"
              ]
            }
          )
        ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-emerald-950/10 border border-emerald-500/20 rounded-[2rem] p-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
              det.saque && Object.entries(det.saque).map(([res, qty]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/40 p-3 rounded-xl border border-white/5 flex flex-col items-center", children: [
              ...
              (!det.saque || Object.values(det.saque).every((v) => v === 0)) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-span-3 py-4 text-center text-neutral-600 text-[10px] font-black uppercase italic", children: "Transmissão: Zero recursos capturados" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
//# sourceMappingURL=Show-Db5J4O4S.js.map
