import { c as createLucideIcon, j as jsxRuntimeExports, $ as $e, a as motion, u as useToasts, r as reactExports, L as Le, S as Sr } from "./app-TubCqXs9.js";
import { H as House, A as AppLayout, f as Mail } from "./app-layout-V4zC7OSH.js";
...
import { C as ChartColumn } from "./chart-column-CWm72p2V.js";
import { S as Shield, T as Target } from "./target-CKTOIwsT.js";
import { S as Send } from "./send-DgzpVbxB.js";
import { T as Trash2 } from "./trash-2-xLYTxoeC.js";
import "./app-logo-icon-BRHpBwyS.js";
import "./index-74uVismz.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          $e,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sword, { size: 18, className: "group-hover:rotate-12 transition-transform" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest hidden md:block", children: "Atacar" })
            ]
          }
        )
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-6 p-6 min-h-[calc(100vh-4rem)]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:w-1/2 flex flex-col", children: composing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/40 border border-white/10 rounded-xl overflow-hidden flex-1 flex flex-col", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 overflow-y-auto flex-1 font-mono text-sm text-neutral-300 whitespace-pre-wrap leading-relaxed", children: viewingMsg.tipo === "espionagem" && viewingMsg.metadata ? /* @__PURE__ */ jsxRuntimeExports.jsx(SpyReport, { report: viewingMsg.metadata }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whitespace-pre-wrap", children: viewingMsg.corpo }),
          (viewingMsg.tipo === "relatorio_ataque" || viewingMsg.tipo === "relatorio_defesa") && viewingMsg.metadata && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 pt-4 border-t border-white/5", children: [
            viewingMsg.metadata.relatorio_id && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              $e,
              {
            ...
            viewingMsg.metadata.target_base_id && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              $e,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Sword, { size: 14 }),
                  " Lançar Ofensiva"
                ]
              }
            )
...
//# sourceMappingURL=mensagens-za9rKRe7.js.map
