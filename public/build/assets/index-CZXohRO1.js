var _=Object.defineProperty;var G=(d,e,t)=>e in d?_(d,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):d[e]=t;var c=(d,e,t)=>G(d,typeof e!="symbol"?e+"":e,t);import{e as r,E as p}from"./EventBus-oyP1N8aw.js";import{e as n,G as E,s as b,a as x}from"./StateManager-D11aFuvh.js";class w{static info(e){console.log(`[INFO] [${new Date().toISOString()}] ${e}`)}static warn(e){console.warn(`[WARN] [${new Date().toISOString()}] ${e}`)}static error(e,t){console.error(`[ERROR] [${new Date().toISOString()}] ${e}`,t)}static event(e,t){}}class P{constructor(){c(this,"keys",{up:!1,down:!1,left:!1,right:!1})}init(){console.log("[SYSTEM] InputSystem - Continuous Sensors ONLINE."),window.addEventListener("keydown",e=>this.handleKeyDown(e)),window.addEventListener("keyup",e=>this.handleKeyUp(e))}handleKeyDown(e){this.updateKeyState(e.code,!0),r.emit({type:p.INPUT_KEY_DOWN,timestamp:Date.now(),data:{code:e.code}})}handleKeyUp(e){this.updateKeyState(e.code,!1),r.emit({type:p.INPUT_KEY_UP,timestamp:Date.now(),data:{code:e.code}})}updateKeyState(e,t){switch(e){case"KeyW":case"ArrowUp":this.keys.up=t;break;case"KeyS":case"ArrowDown":this.keys.down=t;break;case"KeyA":case"ArrowLeft":this.keys.left=t;break;case"KeyD":case"ArrowRight":this.keys.right=t;break}}preUpdate(e){}update(e){r.emit({type:"PLAYER:INPUT_STATE",timestamp:Date.now(),data:{...this.keys}})}postUpdate(e){}destroy(){console.log("[SYSTEM] InputSystem - Continuous Sensors OFFLINE.")}}const k=new P;class B{constructor(){c(this,"currentMode","VILLAGE")}init(){console.log(`[SYSTEM] GameModeSystem - Strategy Layer ONLINE. Initial Mode: ${this.currentMode}`),r.subscribe(p.GAME_CHANGE_MODE,e=>{e.data&&e.data.mode&&this.handleModeChange(e.data.mode)})}handleModeChange(e){if(e!=="VILLAGE"&&e!=="WORLD_MAP"){console.error(`[GAMEMODE_SYSTEM] Invalid mode requested: ${e}`);return}this.currentMode!==e&&(console.log(`[GAMEMODE_SYSTEM] Perspective shift: ${this.currentMode} -> ${e}`),this.currentMode=e,r.emit({type:p.GAMEMODE_CHANGED,timestamp:Date.now(),data:{mode:this.currentMode}}))}getCurrentMode(){return this.currentMode}preUpdate(e){}update(e){}postUpdate(e){}destroy(){console.log("[SYSTEM] GameModeSystem - Strategy Layer OFFLINE.")}}const V=new B;class Y{constructor(){c(this,"accumulator",0);c(this,"TICK_INTERVAL",1)}init(){console.log("[SYSTEM] TimeSystem - Global Clock ONLINE.")}preUpdate(e){}update(e){this.accumulator+=e,this.accumulator>=this.TICK_INTERVAL&&(this.emitTick(),this.accumulator-=this.TICK_INTERVAL)}emitTick(){r.emit({type:"GAME:TICK",timestamp:Date.now(),data:{deltaTime:this.TICK_INTERVAL}})}postUpdate(e){}destroy(){console.log("[SYSTEM] TimeSystem - Global Clock OFFLINE.")}}const $=new Y,z={mina_suprimentos:{resource:"wood",baseProduction:10},refinaria:{resource:"iron",baseProduction:5},fabrica_municoes:{resource:"stone",baseProduction:5}};class W{init(){console.log("[SYSTEM] ResourceSystem - Economic Core ONLINE."),r.subscribe("GAME:TICK",e=>{this.generateResources()})}generateResources(){const e=n.getEntitiesWith(["Resource","Building"]);for(const t of e){const o=n.getComponent(t,"Resource"),i=n.getComponent(t,"Building");if(o&&i){const s=z[i.type];if(!s)continue;const a=i.level||1,l=s.baseProduction*a;s.resource==="all"?(o.wood+=l,o.stone+=l,o.iron+=l):o[s.resource]+=l}}}preUpdate(e){}update(e){}postUpdate(e){}destroy(){console.log("[SYSTEM] ResourceSystem - Economic Core OFFLINE.")}}const H=new W;class K{constructor(e=[]){c(this,"type","BuildQueue");this.queue=e}}class F{init(){console.log("[SYSTEM] BuildQueueSystem - Logistics Core ONLINE."),r.subscribe(p.BUILDING_UPGRADE_REQUEST,e=>{this.handleUpgradeRequest(e)})}handleUpgradeRequest(e){const t=e.data.id;if(t===void 0)return;const o=n.getComponent(t,"Building");if(!o)return;const i=o.villageId,s=n.getComponent(i,"Resource"),a=n.getComponent(i,"BuildQueue");if(!s||!a){console.error(`[BUILD_SYSTEM] Owner ${i} missing Resource or BuildQueue components.`);return}const l=o.level*150;if(s.wood>=l&&s.stone>=l&&s.iron>=l){s.wood-=l,s.stone-=l,s.iron-=l;const h=o.level*5;a.queue.push({type:"UPGRADE",buildingType:o.buildingType,targetEntityId:t,totalTime:h,remainingTime:h}),console.log(`[BUILD_SYSTEM] Upgrade of ${o.name} (LVL ${o.level} -> ${o.level+1}) initiated for Player ${i}.`),r.emit({type:p.BUILDING_REQUEST,entityId:i,timestamp:Date.now(),data:{status:"STARTED",buildingId:t}})}else console.warn(`[BUILD_SYSTEM] Insufficient resources for upgrade of ${o.name}. Required: ${l}`)}update(e){const t=n.getEntitiesWith(["BuildQueue"]);for(const o of t){const i=n.getComponent(o,"BuildQueue");if(i&&i.queue.length>0){const s=i.queue[0];s.remainingTime-=e,s.remainingTime<=0&&(i.queue.shift(),this.completeTask(s))}}}completeTask(e){if(e.type==="UPGRADE"&&e.targetEntityId!==void 0){const t=n.getComponent(e.targetEntityId,"Building");t&&(t.level+=1,console.log(`[BUILD_SYSTEM] Building ${t.name} upgraded to Level ${t.level}!`),r.emit({type:p.BUILDING_COMPLETED,entityId:e.targetEntityId,timestamp:Date.now(),data:{buildingType:e.buildingType,newLevel:t.level}}))}}preUpdate(e){}postUpdate(e){}destroy(){console.log("[SYSTEM] BuildQueueSystem - Logistics Core OFFLINE.")}}const q=new F;class M{constructor(e=100,t=100){c(this,"type","Health");this.value=e,this.max=t}}class v{constructor(e){c(this,"type","Sprite");this.imagePath=e}}class L{constructor(e=10,t=50,o=1,i=0){c(this,"type","Attack");this.power=e,this.range=t,this.cooldown=o,this.lastAttack=i}}class Q{constructor(e="AGGRESSIVE"){c(this,"type","AI");this.behavior=e}}class N{constructor(e,t){c(this,"type","Target");this.x=e,this.y=t}}class X{constructor(e=!0){c(this,"type","Selection");this.isSelected=e}}class Z{init(){console.log("[SYSTEM] OrderSystem - Tactical Downlink ACTIVE."),window.addEventListener("mousedown",this.handleMouseClick.bind(this)),window.addEventListener("contextmenu",e=>e.preventDefault())}preUpdate(e){}update(e){}handleMouseClick(e){const t=e.clientX,o=e.clientY;e.button===0?this.processSelection(t,o):e.button===2&&this.processMoveOrder(t,o)}processSelection(e,t){const o=n.getEntitiesWith(["Position","Sprite"]);let i=!1;n.getEntitiesWith(["Selection"]).forEach(a=>n.removeComponent(a,"Selection"));for(const a of o){const l=n.getComponent(a,"Position");if(Math.sqrt(Math.pow(e-l.x,2)+Math.pow(t-l.y,2))<40){n.addComponent(a,new X),r.emit({type:p.PLAYER_UNIT_SELECTED,entityId:a,timestamp:Date.now(),data:{x:l.x,y:l.y}}),i=!0;break}}i||r.emit({type:p.PLAYER_SELECTION_CLEARED,timestamp:Date.now(),data:{}})}processMoveOrder(e,t){n.getEntitiesWith(["Selection","Position"]).forEach(i=>{n.addComponent(i,new N(e,t)),r.emit({type:p.PLAYER_MOVE_ORDER,entityId:i,timestamp:Date.now(),data:{targetX:e,targetY:t}})})}postUpdate(e){}destroy(){window.removeEventListener("mousedown",this.handleMouseClick),console.log("[SYSTEM] OrderSystem - Tactical Downlink Offline.")}}const j=new Z;class J{init(){console.log("[SYSTEM] AISystem - Decision Engine ACTIVE.")}preUpdate(e){}update(e){const t=n.getEntitiesWith(["AI","Position"]),o=n.getEntitiesWith(["Health","Position"]);for(const i of t){if(n.getComponent(i,"Target"))continue;const s=n.getComponent(i,"AI"),a=n.getComponent(i,"Position");s.behavior==="AGGRESSIVE"&&this.pursueTarget(i,a,o)}}pursueTarget(e,t,o){let i=1/0,s=null;for(const a of o){if(a===e)continue;const l=n.getComponent(a,"Position"),m=Math.sqrt(Math.pow(l.x-t.x,2)+Math.pow(l.y-t.y,2));m<i&&(i=m,s=l)}s&&i>20&&n.addComponent(e,new N(s.x,s.y))}postUpdate(e){}destroy(){console.log("[SYSTEM] AISystem - Decision Engine SUSPENDED.")}}const ee=new J;class te{init(){console.log("[SYSTEM] MovementSystem - Cinematic Processor ONLINE."),r.subscribe("PLAYER:INPUT_STATE",e=>{this.handleInputState(e.data)})}handleInputState(e){const t=n.getEntitiesWith(["Position","Velocity","Player"]);for(const o of t){const i=n.getComponent(o,"Velocity");if(!i)continue;i.vx=0,i.vy=0,e.up&&(i.vy-=1),e.down&&(i.vy+=1),e.left&&(i.vx-=1),e.right&&(i.vx+=1);const s=Math.sqrt(i.vx*i.vx+i.vy*i.vy);s>0&&(i.vx/=s,i.vy/=s)}}preUpdate(e){}update(e){const t=n.getEntitiesWith(["Position","Velocity"]);for(const o of t){const i=n.getComponent(o,"Position"),s=n.getComponent(o,"Velocity");i&&s&&(i.x+=s.vx*e,i.y+=s.vy*e)}}postUpdate(e){}destroy(){console.log("[SYSTEM] MovementSystem - Cinematic Processor OFFLINE.")}}const oe=new te;class ie{init(){console.log("[SYSTEM] CombatSystem - Engagement Protocols Normalizing.")}preUpdate(e){}update(e){const t=Date.now()/1e3,o=n.getEntitiesWith(["Attack","Position"]),i=n.getEntitiesWith(["Health","Position"]);for(const s of o){const a=n.getComponent(s,"Attack"),l=n.getComponent(s,"Position");if(!(t-a.lastAttack<a.cooldown))for(const m of i){if(s===m)continue;const h=n.getComponent(m,"Position");if(Math.sqrt(Math.pow(h.x-l.x,2)+Math.pow(h.y-l.y,2))<=a.range){this.executeAttack(s,m,a.power),a.lastAttack=t;break}}}}executeAttack(e,t,o){const i=n.getComponent(t,"Health");i&&(i.value-=o,r.emit({type:p.COMBAT_UNIT_DAMAGED,entityId:t,timestamp:Date.now(),data:{attackerId:e,damage:o,newHealth:i.value}}),i.value<=0&&r.emit({type:p.COMBAT_UNIT_DESTROYED,entityId:t,timestamp:Date.now(),data:{attackerId:e}}))}postUpdate(e){}destroy(){console.log("[SYSTEM] CombatSystem - Engagement Suspended.")}}const ne=new ie;class se{init(){console.log("[SYSTEM] AttackSystem - Frontline Deployment Operational."),r.subscribe("GAME:TICK",()=>{this.processMarches()})}processMarches(){const e=n.getEntitiesWith(["AttackMarch"]);for(const t of e){const o=n.getComponent(t,"AttackMarch");o&&(o.remainingTime-=1,o.remainingTime<=0&&this.handleMarchArrival(t,o))}}handleMarchArrival(e,t){t.state==="GOING"?(console.log(`[WAR] Attack arrived at [${t.targetX}:${t.targetY}]`),this.resolveCombat(e,t)):t.state==="RETURNING"&&(console.log(`[WAR] Attack returned to origin ${t.originId}`),this.concludeMarch(e,t))}resolveCombat(e,t){const o=n.getEntitiesWith(["Position","Resource"]);let i=null;for(const s of o){const a=n.getComponent(s,"Position");if(Math.round(a.x)===t.targetX&&Math.round(a.y)===t.targetY){i=s;break}}if(i!==null){const s=n.getComponent(i,"Resource");t.loot.wood=Math.floor(s.wood*.5),t.loot.stone=Math.floor(s.stone*.5),t.loot.iron=Math.floor(s.iron*.5),s.wood-=t.loot.wood,s.stone-=t.loot.stone,s.iron-=t.loot.iron,r.emit({type:p.ATTACK_ARRIVED,entityId:e,timestamp:Date.now(),data:{result:"VICTORY",loot:t.loot,targetId:i}})}else r.emit({type:p.ATTACK_ARRIVED,entityId:e,timestamp:Date.now(),data:{result:"EMPTY_TARGET",loot:t.loot}});t.state="RETURNING",t.remainingTime=t.totalTime}concludeMarch(e,t){const o=n.getComponent(t.originId,"Resource");o&&(o.wood+=t.loot.wood,o.stone+=t.loot.stone,o.iron+=t.loot.iron),r.emit({type:p.ATTACK_RETURNED,entityId:e,timestamp:Date.now(),data:{originId:t.originId,finalLoot:t.loot}}),n.destroyEntity(e)}preUpdate(e){}update(e){}postUpdate(e){}destroy(){console.log("[SYSTEM] AttackSystem - Frontline Deployment Offline.")}}const ae=new se;class de{constructor(){c(this,"canvas",null);c(this,"ctx",null);c(this,"images",new Map)}init(){console.log("[SYSTEM] RenderSystem - Initializing Visual Canvas..."),this.createCanvas()}preUpdate(e){}update(e){if(!this.ctx||!this.canvas)return;this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);const t=n.getEntitiesWith(["Position","Sprite"]);for(const o of t){const i=n.getComponent(o,"Position"),s=n.getComponent(o,"Sprite"),a=n.getComponent(o,"Health"),l=n.getComponent(o,"Selection");this.drawEntity(i,s,a,l,o)}}createCanvas(){const e=document.createElement("canvas");e.id="battle-canvas",e.style.position="fixed",e.style.top="0",e.style.left="0",e.style.width="100vw",e.style.height="100vh",e.style.zIndex="50",e.style.pointerEvents="none",e.width=window.innerWidth,e.height=window.innerHeight,document.body.appendChild(e),this.canvas=e,this.ctx=e.getContext("2d")}drawEntity(e,t,o,i,s){if(!this.ctx)return;const a=32,l=n.getComponent(s,"Player"),m=n.getComponent(s,"AI");if(this.ctx.fillStyle=l?"#0ea5e9":m?"#ef4444":"#ffffff",this.ctx.fillRect(e.x-a/2,e.y-a/2,a,a),i&&(this.ctx.strokeStyle="#00ff00",this.ctx.lineWidth=2,this.ctx.strokeRect(e.x-a/2-2,e.y-a/2-2,a+4,a+4)),o){const U=o.value/o.max;this.ctx.fillStyle="#333333",this.ctx.fillRect(e.x-32/2,e.y-a/2-10,32,4),this.ctx.fillStyle=l?"#22c55e":"#ef4444",this.ctx.fillRect(e.x-32/2,e.y-a/2-10,32*U,4)}}postUpdate(e){}destroy(){this.canvas&&this.canvas.parentNode&&this.canvas.parentNode.removeChild(this.canvas)}}const le=new de,f=[k,V,$,H,q,j,ee,oe,ne,ae,le];class re{constructor(){c(this,"lastTime",0);c(this,"running",!1);c(this,"frameId",null)}start(){this.running||(this.running=!0,w.info("[ENGINE] GameLoop starting sequence..."),f.forEach(e=>{try{e.init()}catch(t){console.error("[CRITICAL_FAILURE] System init error:",e,t)}}),this.lastTime=performance.now(),this.frameId=requestAnimationFrame(this.loop.bind(this)))}loop(e){if(!this.running)return;const t=(e-this.lastTime)/1e3;this.lastTime=e;try{f.forEach(o=>o.preUpdate(t)),f.forEach(o=>o.update(t)),f.forEach(o=>o.postUpdate(t))}catch(o){console.error("[GAMELOOP_EXCEPTION] State integrity compromised:",o)}this.frameId=requestAnimationFrame(this.loop.bind(this))}stop(){this.running=!1,this.frameId!==null&&cancelAnimationFrame(this.frameId),f.forEach(e=>e.destroy()),w.info("[ENGINE] GameLoop halted.")}}const ce=new re;class pe{show(){const e=document.getElementById("tactical-hud");e&&(e.style.display="block")}hide(){const e=document.getElementById("tactical-hud");e&&(e.style.display="none")}initialize(){this.createDOM(),this.subscribeToEvents(),console.log("[UI_HUD] Tactical Monitors & Navigation ONLINE.")}createDOM(){var t,o;const e=document.createElement("div");e.id="tactical-hud",e.style.cssText=`
        ...
        `;e.forEach(i=>{const s=n.getComponent(i,"Building");if(s){const a=s.position.x*this.CELL_SIZE,l=s.position.y*this.CELL_SIZE,m=this.selectedBuildingId===i;t+=`
                ...
                `)}this.container.innerHTML=t+o}}const y=new me;class ue{constructor(){c(this,"container",null)}initialize(){this.createDOM(),console.log("[UI_MAP] World Map View INITIALIZED.")}createDOM(){this.container=document.createElement("div"),this.container.id="world-map-view",this.container.style.cssText=`
            position: absolute;
            top: 150px;
            left: 20px;
            z-index: 1000;
        ...
        `,document.body.appendChild(this.container)}show(){this.container&&(this.container.style.display="block")}hide(){this.container&&(this.container.style.display="none")}}const S=new ue;class ge{constructor(){c(this,"screens",new Map)}initialize(){console.log("[UI_MGR] Commands Interfaces NORMALIZING."),T.initialize(),y.initialize(),S.initialize(),r.subscribe(p.GAMEMODE_CHANGED,t=>{this.handleModeChange(t.data.mode)}),r.subscribe(p.GAME_STATE_CHANGED,t=>{const o=t.data.newState;this.handleStateChange(o),o===E.PLAYING?this.handleModeChange(b.getMode()):(y.hide(),S.hide())});let e=!1;r.subscribe(p.INPUT_KEY_DOWN,t=>{t.data.code==="KeyT"&&(e=!e,e?(T.show(),b.getMode()===x.VILLAGE&&y.show()):(T.hide(),y.hide()),console.log(`[UI] Telemetry ${e?"ENABLED":"DISABLED"}`))}),this.createScreens()}handleModeChange(e){console.log("CURRENT MODE:",e),e===x.WORLD_MAP?(y.hide(),S.show()):S.hide()}handleStateChange(e){this.screens.forEach(o=>{o.style.display="none"});const t=this.screens.get(e);t&&(t.style.display="flex")}createScreens(){const e=this.createScreen(E.MENU,"MAIN_MENU");e.innerHTML=`
        ...
        `,document.body.appendChild(e);const t=this.createScreen(E.PLAYING,"GAME_SCREEN");document.body.appendChild(t);const o=this.createScreen(E.PAUSED,"PAUSE_SCREEN");o.innerHTML=`
        ...
        `,document.body.appendChild(o)}createScreen(e,t){const o=document.createElement("div");return o.id=t,o.style.position="fixed",o.style.top="0",o.style.left="0",o.style.width="100vw",o.style.height="100vh",o.style.display="none",o.style.flexDirection="column",o.style.alignItems="center",o.style.justifyContent="center",o.style.backgroundColor="rgba(0,0,0,0.5)",o.style.color="#fff",o.style.fontFamily="monospace",o.style.zIndex="500",this.screens.set(e,o),o}}const he=new ge;class A{constructor(e=0,t=0){c(this,"type","Position");this.x=e,this.y=t}}class C{constructor(e=0,t=0){c(this,"type","Velocity");this.vx=e,this.vy=t}}class D{constructor(){c(this,"type","Player")}}class fe{constructor(e=0,t=0,o=0){c(this,"type","Resource");this.wood=e,this.stone=t,this.iron=o}}class ye{constructor(e){c(this,"type","Village");this.name=e}}class R{constructor(e,t,o,i,s){c(this,"type","Building");this.name=e,this.buildingType=t,this.level=o,this.position=i,this.villageId=s}}console.log("APP START");console.log("BEFORE GAMELOOP");ce.start();he.initialize();const u=n.createEntity();n.addComponent(u,new D);n.addComponent(u,new fe(5e3,5e3,5e3));n.addComponent(u,new K);n.addComponent(u,new ye("Vila Alfa"));n.addComponent(u,new A(100,200));n.addComponent(u,new C(0,0));n.addComponent(u,new M(1e3,1e3));n.addComponent(u,new L(50,150,1));n.addComponent(u,new v("/images/unidades/blindado_apc.png"));const Ee=n.createEntity();n.addComponent(Ee,new R("Quartel General","HQ",1,{x:0,y:0},u));const Ie=n.createEntity();n.addComponent(Ie,new R("Mina de Ferro","MINE",1,{x:1,y:0},u));console.log(`[BOOT] Player Unit Alpha (ID: ${u}) deployed with Spatial Village infrastructure.`);const I=n.createEntity();n.addComponent(I,new D);n.addComponent(I,new A(0,0));n.addComponent(I,new C(0,0));n.addComponent(I,new v("/images/unidades/agente_espiao.png"));console.log(`[BOOT] Test Unit Alpha-Zero (ID: ${I}) deployed at ORIGIN.`);const g=n.createEntity();n.addComponent(g,new A(500,200));n.addComponent(g,new C(0,0));n.addComponent(g,new M(2e3,2e3));n.addComponent(g,new L(100,200,3));n.addComponent(g,new Q("AGGRESSIVE"));n.addComponent(g,new v("/images/unidades/tanque_combate.png"));console.log(`[BOOT] Enemy Unit Omega (ID: ${g}) detected with Main Battle Tank.`);b.setState(E.PLAYING);console.log("--- OPERATIONS ACTIVE: VISUAL TACTICAL ENGAGEMENT ONGOING ---");
