import { c as createLucideIcon, u as useToasts, U, f as eventBus, E as Events, S as Sr, j as jsxRuntimeExports, L as Le, $ as $e } from "./app-BzAfNwp0.js";
import { A as AppLayout, M as Map, C as ChevronRight } from "./app-layout-i__BbL2H.js";
import { a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-BQkmuFP2.js";
...
import "./dialog-D9M0TCdy.js";
import "./sword-8-00Cf5N.js";
import "./loader-circle-D3V5PYO7.js";
/**
...
function Mapa({ bases, x, y, raio, origemBase, gameConfig, ataquesEnviados, ataquesRecebidos, diplomacia, userAliancaId, auth, general, targetId }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col gap-6 p-6 bg-neutral-900 text-white min-h-screen", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-[2px] bg-black/20 p-2 rounded-xl border border-white/10 shadow-2xl overflow-auto max-w-full max-h-[75vh]", children: grid.map((row, rowIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-[2px]", children: row.map((cell, cellIndex) => {
        ...
        const isNpc = (_a = cell.base) == null ? void 0 : _a.is_npc;
        ...
        const diploStatus = ((_c = (_b = cell.base) == null ? void 0 : _b.jogador) == null ? void 0 : _c.alianca_id) ? getDiplomacyStatus(cell.base.jogador.alianca_id) : null;
...
//# sourceMappingURL=mapa-Uew3wjcO.js.map
