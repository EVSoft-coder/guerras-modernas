import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, t, X, K, $ as $e, U } from "./app-BXZvBmUM.js";
import { c as cn, u as useComposedRefs, S as Slot, a as cva, b as Slottable, B as Button, d as composeRefs, A as AppLogoIcon } from "./app-logo-icon-CV6jrIDy.js";
import { P as Primitive, d as dispatchDiscreteCustomEvent, R as ReactDOM, r as reactDomExports, I as Input } from "./index-BLKPMz1w.js";
import { d as useLayoutEffect2, e as useCallbackRef$1, c as composeEventHandlers, u as useControllableState, P as Presence, b as createContextScope, f as createContext2, a as useSize, C as Check } from "./index-B_YXD-Vz.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { className: "px-2 py-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SidebarMenuButton,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs($e, { href: item.url, prefetch: true, children: [
          item.icon && /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: item.url === page.url ? "text-sky-400" : "text-neutral-400 group-hover/nav:text-sky-300 transition-colors" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-black uppercase tracking-widest text-[11px] transition-colors ${item.url === page.url ? "text-white" : "text-neutral-100 group-hover/nav:text-white"}`, children: item.title })
        ] })
      }
    ) }, item.title)) })
  ] });
...
function AppLogo() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-1 py-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sky-500 flex aspect-square size-9 items-center justify-center transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppLogoIcon, { className: "size-7 fill-current drop-shadow-[0_0_10px_rgba(14,165,233,0.5)]" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-black truncate leading-none uppercase tracking-tighter text-white", children: "Guerras" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] truncate font-bold uppercase tracking-[0.2em] text-sky-500/80", children: "Modernas" })
    ] })
  ] });
}
const mainNavItems = [
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", variant: "inset", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { size: "lg", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { href: "/dashboard", prefetch: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppLogo, {}) }) }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavMain, { items: mainNavItems }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { className: "px-2 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroupLabel, { className: "text-[10px] font-black uppercase tracking-[0.4em] text-sky-400 mb-4 px-4 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 bg-sky-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(14,165,233,0.5)]" }),
          "COMMAND_PROTOCOLS"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarMenu, { className: "gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            SidebarMenuButton,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "text-neutral-400 group-hover:text-sky-400 transition-colors" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black uppercase tracking-widest text-[11px] text-white/90 group-hover:text-white transition-colors", children: "Sector_Alfa (Base)" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            SidebarMenuButton,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Map$1, { className: "text-neutral-400 group-hover:text-red-500 transition-colors" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black uppercase tracking-widest text-[11px] text-white/90 group-hover:text-white transition-colors", children: "Globo_Tático (Mapa)" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarMenuButton, { className: "sidebar-tactical-item h-12 px-4 group opacity-20 cursor-not-allowed", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "text-neutral-600" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-black uppercase tracking-widest text-[11px] text-neutral-500", children: "Obj_Primários" })
          ] }) })
        ] })
      ] })
    ] }),
...
//# sourceMappingURL=app-layout-DCQvUe7p.js.map
