...
import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, m as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, a as me, z as useToasts, B as eventBus, E as Events, L as Le } from "./app-DDre5OM8.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-BcsW0NiY.js";
import { S as Shield } from "./shield-DPJ1DT84.js";
import { U as Users } from "./users-CbqOy8g1.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-DafOfQGZ.js";
import { B as Button } from "./app-logo-icon-DdCZwW2r.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-UkYeQbHn.js";
import { L as LoaderCircle } from "./loader-circle-_NaYjy9L.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-BUvgJwt0.js";
import { I as Input } from "./index-BS9oFYmt.js";
import { g as gameStateService } from "./GameStateService-CzvVLXwu.js";
import { S as Sword } from "./sword-B5UCaw4d.js";
import "./index-heWIbNVJ.js";
...
function WorldMapView({ playerBase, troops = [], gameConfig }) {
  ...
  const visibleBases = reactExports.useMemo(() => {
    return gameEntities.filter((e) => e.type === "VILLAGE" || e.type === "village").map((e) => ({
      ...
      protection_until: e.protectionUntil ? new Date(e.protectionUntil).toISOString() : void 0,
      jogador: e.ownerId ? { id: e.ownerId, username: e.ownerId === (playerBase == null ? void 0 : playerBase.jogador_id) ? "VOCÊ" : `COMANDANTE_${e.ownerId}` } : void 0
    }));
  ...
  const debugRebels = [
    { id: 9991, coordenada_x: ((playerBase == null ? void 0 : playerBase.coordenada_x) || center.x) + 2, coordenada_y: ((playerBase == null ? void 0 : playerBase.coordenada_y) || center.y) + 2, jogador_id: null, nome: "REBELDE_A" },
    { id: 9992, coordenada_x: ((playerBase == null ? void 0 : playerBase.coordenada_x) || center.x) - 2, coordenada_y: ((playerBase == null ? void 0 : playerBase.coordenada_y) || center.y) - 1, jogador_id: null, nome: "REBELDE_B" }
  ];
...
//# sourceMappingURL=dashboard-DGBLlvlh.js.map
