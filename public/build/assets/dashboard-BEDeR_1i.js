import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, m as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, a as me, z as axios, B as useToasts, C as eventBus, E as Events, L as Le } from "./app-C1SYZRJv.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-Dp0M_yz_.js";
import { S as Shield } from "./shield--9jYbwlT.js";
import { U as Users } from "./users-8oPlx6k7.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-D30M-C7C.js";
import { B as Button } from "./app-logo-icon-buzkRdyJ.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-Bboq6btT.js";
import { L as LoaderCircle } from "./loader-circle-BJIGA0FV.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-Dzx3QXIU.js";
import { I as Input } from "./index-CM6TbHkw.js";
import { g as gameStateService } from "./GameStateService-B4yl27MB.js";
import "./index-BWIfWSsc.js";
import "./sword-eqHicXOv.js";
...
const Boxes = createLucideIcon("Boxes", __iconNode$7);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Fuel = createLucideIcon("Fuel", __iconNode$6);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Hammer = createLucideIcon("Hammer", __iconNode$5);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: Array.from({ length: 20 }).map((_, y) => Array.from({ length: 20 }).map((_2, x) => {
                  var _a2;
                  ...
                  const isEnemy = baseAt && baseAt.jogador_id !== (playerBase == null ? void 0 : playerBase.jogador_id);
                  const isPlayerBase = baseAt && baseAt.jogador_id === (playerBase == null ? void 0 : playerBase.jogador_id);
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute top-1 left-1 text-[8px] font-mono text-neutral-800 opacity-20 group-hover:opacity-100 transition-opacity", children: [
                            x.toString().padStart(2, "0"),
                            ":",
                            y.toString().padStart(2, "0")
                          ] }),
                          baseAt && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            motion.div,
                            {
                              ...
                              className: `p-3 rounded-xl border-2 shadow-2xl
                                                            ...
                                                            `,
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(House, { size: 24 })
                            }
                          )
                        ]
                      }
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { className: "bg-black/90 border-white/10 p-4 rounded-2xl shadow-2xl side-top", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { size: 12, className: isEnemy ? "text-red-500" : "text-sky-500" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase text-white", children: (baseAt == null ? void 0 : baseAt.nome) || "Sector Neutro" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-4 text-[8px] font-mono text-neutral-500", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                          "OWNER: ",
                          ((_a2 = baseAt == null ? void 0 : baseAt.jogador) == null ? void 0 : _a2.username) || "NONE"
                        ] })
                      ] })
                    ] }) })
                  ] }, `${x}-${y}`);
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none z-30", children: gameEntities.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative group cursor-pointer", onClick: () => setSelectedUnit(e.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-8 overflow-auto custom-scrollbar", children: selectedSector.base ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
            ...
            selectedSector.base.jogador_id !== (playerBase == null ? void 0 : playerBase.jogador_id) && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
...
//# sourceMappingURL=dashboard-BEDeR_1i.js.map
