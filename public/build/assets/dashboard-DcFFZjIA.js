import { c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, I as Info, r as reactExports, a as motion, U, X, A as AnimatePresence, b as axios, S as Sr, e as eventBus, E as Events, u as useToasts, d as Logger, L as Le, $ as $e } from "./app-CTMShhOw.js";
import { b as LayoutGrid, C as ChevronRight, T as TooltipProvider, A as AppLayout } from "./app-layout-uhJLFUEu.js";
import { P as Package } from "./package-DLnJJY1q.js";
import { T as Target, S as Shield } from "./target-BihZp87V.js";
import { U as Users } from "./users-CJu9AMuA.js";
import { B as Button, c as cn } from "./app-logo-icon-ZD-RVzx-.js";
import { C as Check } from "./index-B54qfxHz.js";
import { D as Dialog, a as DialogContent, b as DialogTitle, c as DialogDescription, d as DialogFooter } from "./dialog-DpWf282a.js";
import { S as ShoppingCart, B as Badge, C as Clock, a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-BNO2M1Cn.js";
import { t as toast, H as Hammer, S as ShieldAlert } from "./index-hgOTkFww.js";
import { P as Plus } from "./plus-CS--YFwI.js";
import { L as LoaderCircle } from "./loader-circle-Ba5FkxZv.js";
import { U as User } from "./user-BiXoTKWz.js";
import { S as Sword } from "./sword-D21GydJO.js";
import { I as Input } from "./index-CHp288mV.js";
import { g as gameStateService } from "./GameStateService-CgTISxnS.js";
import { S as Search } from "./search-FdfTabbL.js";
import { C as ChevronLeft } from "./chevron-left-MIaYOJD0.js";
import { T as Truck } from "./truck-Cy_bTdVh.js";
import { C as Crosshair } from "./crosshair-COtdLEQ_.js";
import { G as Globe, B as Book } from "./globe-C1qXn64n.js";
import { r as resourceSystem } from "./ResourceSystem-vTHKHtxR.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-none opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-y-4 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black border border-white/20 rounded shadow-[0_20px_50px_rgba(0,0,0,1)] min-w-[150px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 border-b border-white/10 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-black text-white uppercase tracking-wider block", children: type.replace("_", " ") }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2 flex items-center justify-center gap-3 bg-white/[0.03]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black text-zinc-500 uppercase tracking-widest", children: "NÍVEL" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-black font-military-mono text-zinc-300", children: level.toString().padStart(2, "0") })
          ] }),
          isConstructing && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-orange-500/10 py-1 border-t border-orange-500/20 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-black text-orange-400 uppercase tracking-widest animate-pulse", children: "CONSTRUINDO" }) })
        ] }) }),
...
//# sourceMappingURL=dashboard-DcFFZjIA.js.map
