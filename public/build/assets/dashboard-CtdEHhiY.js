import { i as isEasingArray, V as VisualElement, a as createBox, b as resolveElements, d as mixNumber, e as removeItem, f as isMotionValue, g as defaultOffset, h as createGeneratorEasing, k as fillOffset, l as isGenerator, s as secondsToMilliseconds, p as progress, n as isSVGElement, o as isSVGSVGElement, q as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, w as animateTarget, x as motionValue, y as spring, c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, r as reactExports, z as motion$1, X, U, A as AnimatePresence, S as Sr, B as eventBus, E as Events, u as useToasts, C as Logger, L as Le, $ as $e } from "./app-DAFP025T.js";
import { C as ChevronRight, T as TooltipProvider, A as AppLayout } from "./app-layout-De4jNZzi.js";
import { S as Shield, T as Target } from "./target-73ZvqoP3.js";
import { U as Users } from "./users-CqaOC-4M.js";
import { C as Check } from "./index-DN3zf2IG.js";
import { D as Dialog, a as DialogContent, b as DialogTitle, c as DialogFooter } from "./dialog-Dw9mZUqw.js";
import { B as Button$1, c as cn } from "./app-logo-icon-CioCRvVm.js";
import { B as Badge, C as Clock, a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-ghSw7Ce4.js";
import { L as LoaderCircle } from "./loader-circle-Cdojrxu8.js";
import { I as Input } from "./index-Ctap5GIy.js";
import { g as gameStateService } from "./GameStateService-CbtWj79W.js";
import { S as Search } from "./search-D0AraRUU.js";
import { C as ChevronLeft } from "./chevron-left-CFBJM_UA.js";
import { S as Sword } from "./sword-YpR1x-oe.js";
import { C as Crosshair } from "./crosshair-b0Q-ACa5.js";
import { G as Globe, B as Book } from "./globe-8RZJ9FgM.js";
import { r as resourceSystem } from "./ResourceSystem-DzxCGUsk.js";
...
const TransparentImage = ({ src, tolerance = 90, targetColor, ...props }) => {
  ...
  if (!processedSrc) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, ...props, style: { ...props.style, opacity: 0 } });
  }
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
        !isInvalid ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          TransparentImage,
          {
            ...
            tolerance: ((_b = layout.transparency) == null ? void 0 : _b.tolerance) || 90,
            style: {
              width: "100%",
              height: "100%",
              objectFit: "contain",
        ...
        return {
          ...
          [type]: {
            ...
            transparency: {
              ...
              targetColor: color,
              tolerance: ((_a2 = prev[type].transparency) == null ? void 0 : _a2.tolerance) || 90
            }
          }
        };
      });
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative w-full h-full transition-transform duration-300 ${selected === type ? "scale-110" : "hover:scale-105"}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    TransparentImage,
                    {
                      ...
                      tolerance: ((_b = b.transparency) == null ? void 0 : _b.tolerance) || 90,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-[800px] w-full gap-0 overflow-hidden rounded-[3rem] border border-white/10 bg-[#05080f] shadow-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute left-6 top-6 bottom-6 z-40 transition-all duration-500 flex gap-4 ${isSidebarOpen ? "w-[320px]" : "w-0"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex-1 bg-black/60 backdrop-blur-3xl border border-white/10 rounded-[2rem] overflow-hidden flex flex-col shadow-2xl transition-opacity duration-300 ${isSidebarOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-black/40 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { size: "icon", className: "h-8 w-12 bg-sky-600 hover:bg-sky-500", onClick: handleSearch, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14 }) })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-10 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-4 w-full px-20 max-w-5xl pointer-events-none", children: [
        ...
        motion$1.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { disabled: true, className: "bg-sky-600/20 text-sky-400 border-sky-500/20 text-[10px] font-black uppercase px-10 py-6 rounded-2xl", children: "Zona Aliada" })
            ] })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-black/60 backdrop-blur-xl border border-white/10 px-8 py-3 rounded-full flex items-center gap-8 shadow-2xl pointer-events-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "ghost", size: "sm", onClick: () => zoom > 0.5 && setZoom((z) => z - 0.2), className: "text-neutral-400", children: "-" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "ghost", size: "sm", onClick: () => zoom < 1.8 && setZoom((z) => z + 0.2), className: "text-neutral-400", children: "+" }),
...
//# sourceMappingURL=dashboard-CtdEHhiY.js.map
