...
import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, a as motion, U, y as Logger, A as AnimatePresence, T as TriangleAlert, X, I as Info, z as Sr, m as me, B as eventBus, E as Events, C as useToasts, L as Le } from "./app-BGqIn98w.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-CMjnf6ed.js";
import { S as Shield } from "./shield-BwaRZmk_.js";
import { U as Users } from "./users-BgEEIsK2.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-CtkAgMYK.js";
import { B as Button } from "./app-logo-icon-CnLAvyDx.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-CosQFJ2q.js";
import { L as LoaderCircle } from "./loader-circle-BJMPezSW.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-CiKqjIdt.js";
import { I as Input } from "./index-Dl0EGl2x.js";
import { g as gameStateService } from "./GameStateService-C3hEv0D9.js";
import { S as Sword } from "./sword-3KArB5WI.js";
import "./index-k1qIU0Gs.js";
  ...
  reactExports.useEffect(() => {
    const interval = setInterval(() => {
      setCurrent((prev) => ({
        ...
        pessoal: prev.pessoal + ((taxasPerSecond == null ? void 0 : taxasPerSecond.pessoal) ?? 0),
        cap: (recursos == null ? void 0 : recursos.cap) ?? 1e4
      }));
    }, 1e3);
...
const ResourceItem = ({ icon, label, value, rate, cap, color, accentColor, isStatic = false, customValue }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center bg-black/40 backdrop-blur-3xl p-6 rounded-[2.5rem] border border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.6)] group cursor-help transition-all duration-500 hover:bg-white/[0.05] hover:border-white/10 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-full text-[9px] font-mono uppercase text-neutral-400", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between border-t border-white/5 pt-1 mt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sky-400 font-black", children: [
            Math.min(100, Number(value) / cap * 100).toFixed(1),
            "%"
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedNumber, { value, customValue })
      },
      value
    ),
...
const BuildingNode = ({ buildingType, nome, nivel, gridPos, isConstructing, isLocked, onClick }) => {
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group/bldg transition-all duration-300", children: [
          !isLocked && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute inset-0 bg-sky-500/0 group-hover:bg-sky-500/10 blur-xl rounded-full transition-all duration-300 ${isGhost ? "group-hover:bg-orange-500/10" : ""}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.img,
            {
              src: imgUrl,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute -bottom-1 -right-1 bg-neutral-950 border ${isLocked ? "border-red-500/40" : isGhost ? "border-orange-500/40" : "border-sky-500/40"} rounded-md px-1.5 py-0.5 shadow-xl backdrop-blur-md z-20`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9px] font-mono font-black text-white ${isLocked ? "text-red-500" : isGhost ? "text-orange-500" : ""}`, children: isLocked ? "🔒" : isGhost ? "+" : nivel ?? 0 }) }),
          isConstructing && !isLocked && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full border-2 border-orange-500 border-t-transparent rounded-full animate-spin opacity-60" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-1 flex flex-col items-center bg-black/40 px-2 py-0.5 rounded border border-white/5 backdrop-blur-sm ${!isLocked ? "opacity-60 group-hover:opacity-100" : "opacity-40"} transition-opacity`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] font-black uppercase text-neutral-300 tracking-tighter whitespace-nowrap", children: nome ?? "UNKNOWN" }) })
      ]
    }
  );
};
const buildingConfigs = {
  ...
  parlamento: {
    ...
    cost: { suprimentos: 3e3, metal: 2e3, pessoal: 10, energia: 500 },
    timeBase: 1800,
    requires: { qg: 10 }
  }
};
const VillageView = ({ base, onBuildingClick, gameConfig }) => {
  ...
  const playerBuildings = U.useMemo(() => {
    var _a;
    const list = [
      ...
      ...((_a = base.edificios) == null ? void 0 : _a.filter((eb) => {
        var _a2;
        const t = (_a2 = eb.buildingType) == null ? void 0 : _a2.toLowerCase();
        return t !== "qg" && t !== "muralha";
      }).map((eb) => {
        var _a2;
        let type = (_a2 = eb.buildingType) == null ? void 0 : _a2.toLowerCase();
  ...
  const buildings = bConfigs.map((b) => {
    const existing = playerBuildings == null ? void 0 : playerBuildings.find(
      (pb) => pb.type.toLowerCase() === b.id.toLowerCase()
    );
    return {
      ...b,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full aspect-video bg-black rounded-[2.5rem] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.9)] border border-white/5 group", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-20 grid grid-cols-5 grid-rows-5 p-8 md:p-12 lg:p-16 gap-2", children: buildings.map((b) => {
...
const BuildingModal = ({
  ...
  const availableUnits = isMilitary ? Object.entries((gameConfig == null ? void 0 : gameConfig.units) || {}).filter(([key, unit]) => isAvailable(key)) : [];
  reactExports.useEffect(() => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 p-6 md:p-8 flex flex-col bg-neutral-900/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { className: "mb-4 md:mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-sky-500 font-bold uppercase tracking-widest flex items-center gap-2", children: [
                ...
                " Setor de ",
                ((_f = (_e = (_d = (_c = building.buildingType) == null ? void 0 : _c.replace) == null ? void 0 : _d.call(_c, "_", " ")) == null ? void 0 : _e.toUpperCase) == null ? void 0 : _f.call(_e)) ?? "ESTRUTURA"
              ] })
            ] }) }),
  ...
  const unifiedQueue = [
    ...construcoes.map((c) => {
      ...
      return {
        ...
        label: ((_a = c.buildingType) == null ? void 0 : _a.replace(/_/g, " ")) || "Estrutura",
...
function WorldMapView({ playerBase, troops = [], gameConfig }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-6 w-full animate-in fade-in slide-in-from-bottom-4 duration-700 h-full overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      StrategyHUD,
      {
        resources: (playerBase == null ? void 0 : playerBase.recursos) || {},
        coordinates: center,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-black uppercase tracking-tighter text-white flex items-center gap-3", children: [
              ...
              displayBases.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 ml-4 self-center", children: displayBases.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { breadcrumbs, children: [
      ...
      props.base && /* @__PURE__ */ jsxRuntimeExports.jsx(
        WorldMapView,
        {
          ...
          troops: ((_e = props.gameData) == null ? void 0 : _e.units) ?? ((_f = props.base) == null ? void 0 : _f.tropas),
...
//# sourceMappingURL=dashboard-z72CaLGa.js.map
