import { c as createLucideIcon, u as useToasts, U, B as eventBus, E as Events, S as Sr, j as jsxRuntimeExports, L as Le, $ as $e } from "./app-DOd-r0do.js";
import { A as AppLayout, M as Map, C as ChevronRight } from "./app-layout-CF6k8CXE.js";
import { a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-D8VLmDiQ.js";
...
import { T as Target } from "./target-CgQ7PbcR.js";
import "./app-logo-icon-CtMCeIJP.js";
import "./index-CkdW7dZU.js";
import "./index-BBgI2Nrp.js";
import "./dialog-W3Hv9P6b.js";
import "./sword-ikddFNpM.js";
import "./loader-circle-DTfxX-ud.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col gap-6 p-6 bg-neutral-900 text-white min-h-screen", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-[2px] bg-black/20 p-2 rounded-xl border border-white/10 shadow-2xl overflow-auto max-w-full max-h-[75vh]", children: grid.map((row, rowIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-[2px]", children: row.map((cell, cellIndex) => {
        var _a;
        const isOwn = cell.base && cell.base.ownerId === (origemBase == null ? void 0 : origemBase.ownerId);
...
//# sourceMappingURL=mapa-DuKfCQaK.js.map
