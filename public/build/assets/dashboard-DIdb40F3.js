import { i as isEasingArray, V as VisualElement, a as createBox, b as resolveElements, d as mixNumber, e as removeItem, f as isMotionValue, g as defaultOffset, h as createGeneratorEasing, k as fillOffset, l as isGenerator, s as secondsToMilliseconds, p as progress, n as isSVGElement, o as isSVGSVGElement, q as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, w as animateTarget, x as motionValue, y as spring, c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, r as reactExports, z as motion, X, U, A as AnimatePresence, S as Sr, B as eventBus, E as Events, u as useToasts, C as Logger, L as Le, $ as $e } from "./app-DdRauoZk.js";
import { C as ChevronRight, T as TooltipProvider, A as AppLayout } from "./app-layout-T-zeZie-.js";
import { S as Shield, T as Target } from "./target-BfUohUbE.js";
import { U as Users } from "./users-DPeFV2B4.js";
import { B as Button, c as cn } from "./app-logo-icon-CVLnt-Ci.js";
import { C as Check } from "./index-BSdzNlXa.js";
import { D as Dialog, a as DialogContent, b as DialogTitle, c as DialogFooter } from "./dialog-D5WL2cC_.js";
import { B as Badge, C as Clock, a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-BI7H23Af.js";
import { L as LoaderCircle } from "./loader-circle-Bp6XIWZ0.js";
import { I as Input } from "./index-CeIbEZGH.js";
import { g as gameStateService } from "./GameStateService-DxDz7FVL.js";
import { S as Search } from "./search-D1BhukHe.js";
import { C as ChevronLeft } from "./chevron-left-BPRbFJ2U.js";
import { S as Sword } from "./sword-BAV6RjpP.js";
import { C as Crosshair } from "./crosshair-quyLi5DQ.js";
import { G as Globe, B as Book } from "./globe-CeRvfpYn.js";
import { r as resourceSystem } from "./ResourceSystem-D3_cl_0_.js";
...
const Fuel = createLucideIcon("Fuel", __iconNode$d);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Move = createLucideIcon("Move", __iconNode$a);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const LayoutCalibrator = ({ onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[200] bg-black/95 flex flex-col items-center justify-center p-4 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-6xl bg-[#0a0c10] border border-gray-800 rounded-2xl overflow-hidden shadow-[0_0_100px_rgba(0,0,0,1)] flex flex-col h-[90vh]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 border-b border-gray-800 flex items-center justify-between bg-black/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-bold tracking-[0.2em] uppercase text-base", children: "Calibrador de Layout V30" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative bg-[#050608] flex-1 flex items-center justify-center p-20 overflow-hidden bg-[radial-gradient(#111_1px,transparent_1px)] [background-size:20px_20px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
          ...
          Object.entries(layout).map(([type, b]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              style: {
                left: b.x - b.w / 2,
                top: b.y - b.h / 2,
                // Usamos centro no calibrador para alinhar com o rato
                width: b.w,
                height: b.h,
                zIndex: selected === type ? 1e3 : Math.floor(b.y)
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative w-full h-full transition-all duration-300 ${selected === type ? "scale-125" : "hover:scale-105"}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                selected === type && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 border-2 border-cyan-500 rounded-lg animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute -top-8 left-1/2 -translate-x-1/2 px-3 py-1 rounded border font-mono whitespace-nowrap pointer-events-none transition-all ${selected === type ? "bg-cyan-500 text-black border-cyan-400 font-bold scale-110" : "bg-black/90 text-cyan-400 border-cyan-500/30 text-[10px]"}`, children: [
                  type.toUpperCase(),
                  " [",
                  b.x,
                  ", ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-t border-gray-800 bg-black/60 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-mono italic", children: "ENGINEERING_TOOL_V3.0" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-gray-600 uppercase font-bold", children: "Resolução Ativa" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400 font-mono", children: "800 X 600 PX" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900/50 px-4 py-2 rounded-lg border border-gray-800 text-[10px] text-gray-500 max-w-md text-right leading-relaxed italic", children: [
        'Nota: Após posicionar todos os edifícios, clique em "Copiar Configuração" e atualize o ficheiro ',
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cyan-500 font-bold", children: "buildingLayout.ts" }),
        " com o novo JSON."
      ] })
    ] })
  ] }) });
...
//# sourceMappingURL=dashboard-DIdb40F3.js.map
