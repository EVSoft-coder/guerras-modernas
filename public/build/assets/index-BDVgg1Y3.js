const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/app-CYijzaBE.js","assets/app-DYabfW0d.css"])))=>i.map(i=>d[i]);
var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
import { B as eventBus, E as Events, y as Logger, _ as __vitePreload, M as axios } from "./app-CYijzaBE.js";
import { g as gameStateService$1, e as entityManager, s as stateManager, G as GameState, a as GameMode } from "./GameStateService-W-tRWF3b.js";
const unitConfigs = {
  infantaria: {
    id: "infantaria",
...
class GameModeSystem {
  ...
  handleModeChange(newMode) {
    ...
    gameStateService$1.setMode(newMode);
  }
  getCurrentMode() {
...
class ResearchSystem {
  ...
  update(deltaTime) {
    const globalState = gameStateService$1.getGlobalState();
  ...
  async handleBuildingUpgrade(data) {
    ...
    try {
      ...
      const { router } = await __vitePreload(async () => {
        const { router: router2 } = await import("./app-CYijzaBE.js").then((n) => n.N);
...
class IntelSystem {
  ...
  update(deltaTime) {
    ...
    gameStateService$1.updateGlobalState({ revealedTiles: Array.from(this.revealedTiles) });
  }
...
//# sourceMappingURL=index-BDVgg1Y3.js.map
