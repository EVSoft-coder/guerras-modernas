import { c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, I as Info, r as reactExports, a as motion, U, X, A as AnimatePresence, S as Sr, e as eventBus, E as Events, u as useToasts, b as Logger, L as Le, $ as $e } from "./app-BCrsTa_v.js";
import { C as ChevronRight, T as TooltipProvider, A as AppLayout } from "./app-layout-CTpjdtek.js";
import { P as Package } from "./package-BVKNSZNt.js";
import { T as Target, S as Shield } from "./target-CVDh-GdJ.js";
import { U as Users } from "./users-DBbGUNla.js";
import { B as Button, c as cn } from "./app-logo-icon-COdvkLs8.js";
import { C as Check } from "./index-DxNbjkOn.js";
import { D as Dialog, a as DialogContent, b as DialogTitle, c as DialogDescription, d as DialogFooter } from "./dialog-ICZTjY_0.js";
import { B as Badge, C as Clock, a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-DWjmqyWz.js";
import { L as LoaderCircle } from "./loader-circle-CkP3hGEn.js";
import { I as Input } from "./index-F15f6Hlb.js";
import { g as gameStateService } from "./GameStateService-Bt7R84a0.js";
import { S as Search } from "./search-D5YWZXRt.js";
import { C as ChevronLeft } from "./chevron-left-BOLFzsQo.js";
import { S as Sword } from "./sword-D5xFSVh3.js";
import { C as Crosshair } from "./crosshair-C6XHhzGm.js";
import { G as Globe, B as Book } from "./globe-C0p8UIxw.js";
import { r as resourceSystem } from "./ResourceSystem-53xxpN3p.js";
/**
...
const Activity$1 = createLucideIcon("Activity", __iconNode$k);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const FlaskConical = createLucideIcon("FlaskConical", __iconNode$e);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const LayoutGrid = createLucideIcon("LayoutGrid", __iconNode$b);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Pipette = createLucideIcon("Pipette", __iconNode$7);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PlaneLanding = createLucideIcon("PlaneLanding", __iconNode$6);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PlaneTakeoff = createLucideIcon("PlaneTakeoff", __iconNode$5);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const ShieldAlert = createLucideIcon("ShieldAlert", __iconNode$3);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-none transition-all duration-500 group-hover:-bottom-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-3 py-1 rounded-lg border backdrop-blur-xl shadow-[0_10px_30px_rgba(0,0,0,0.5)] flex flex-col items-center min-w-[80px] transition-all duration-500 ${isConstructing ? "bg-orange-500/10 border-orange-500/20 group-hover:border-orange-500/40" : "bg-black/60 border-white/5 group-hover:border-cyan-500/30"}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[11px] font-black font-military-mono leading-none tracking-tighter ${isConstructing ? "text-orange-400" : "text-white group-hover:text-cyan-400"}`, children: isConstructing ? "UNDER_CONST" : `LVL_${level.toString().padStart(2, "0")}` })
          ] }),
...
const BuildingModal = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: isOpen, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-4xl bg-[#020406]/90 border-white/5 text-white overflow-hidden backdrop-blur-3xl p-0 rounded-[3rem] shadow-[0_0_120px_rgba(0,0,0,1)] flex flex-col md:flex-row h-[90vh] md:h-auto border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-[45%] bg-black/40 relative flex flex-col items-center justify-center p-12 border-b md:border-b-0 md:border-r border-white/5 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 w-full space-y-6 z-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-8xl font-black text-white italic tracking-tighter leading-none font-military-mono", children: (building.nivel || 0).toString().padStart(2, "0") })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-10 md:p-14 flex flex-col justify-between bg-gradient-to-br from-black/20 via-transparent to-transparent relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "absolute top-10 right-10 text-neutral-600 hover:text-white transition-all p-2.5 hover:bg-white/5 rounded-2xl active:scale-90", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-12 overflow-y-auto pr-6 custom-scrollbar max-h-[60vh]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-[11px] text-neutral-500 font-medium leading-relaxed max-w-lg", children: config.description })
        ] }),
        isMilitary ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
...
const ArmyMovementPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tactical-glass border-white/5 backdrop-blur-3xl overflow-hidden mb-8 rounded-[2rem] shadow-[0_30px_60px_rgba(0,0,0,0.8)] relative group border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent ${(ataquesRecebidos == null ? void 0 : ataquesRecebidos.length) > 0 ? "via-red-500" : "via-cyan-500/50"} to-transparent shadow-[0_0_15px_rgba(239,68,68,0.5)]` }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 bg-white/[0.01] border-b border-white/5 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-2 rounded-xl border ${(ataquesRecebidos == null ? void 0 : ataquesRecebidos.length) > 0 ? "bg-red-500/10 border-red-500/20" : "bg-cyan-500/10 border-cyan-500/20"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: (ataquesRecebidos == null ? void 0 : ataquesRecebidos.length) > 0 ? "text-red-500 animate-pulse" : "text-cyan-500", size: 18 }) }),
      ...
      (ataquesRecebidos == null ? void 0 : ataquesRecebidos.length) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-1 bg-red-500/20 border border-red-500/40 rounded-full animate-pulse", children: [
...
//# sourceMappingURL=dashboard-DWvqjEpV.js.map
