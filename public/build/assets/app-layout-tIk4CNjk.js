import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, t, X, K, $ as $e, U, F as FlashListener } from "./app-DpVMLtDv.js";
import { c as cn, u as useComposedRefs, S as Slot, b as cva, d as Slottable, B as Button, e as composeRefs, A as AppLogoIcon } from "./app-logo-icon-CPUcFckN.js";
import { P as Primitive, d as dispatchDiscreteCustomEvent, R as ReactDOM, r as reactDomExports, I as Input } from "./index-tTnglD3x.js";
import { d as useLayoutEffect2, e as useCallbackRef$1, c as composeEventHandlers, u as useControllableState, P as Presence, b as createContextScope, f as createContext2, a as useSize, C as Check } from "./index-JVWizm85.js";
...
const ChevronsUpDown = createLucideIcon("ChevronsUpDown", __iconNode$c);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const LayoutGrid = createLucideIcon("LayoutGrid", __iconNode$6);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PanelLeft = createLucideIcon("PanelLeft", __iconNode$2);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
var useReactId = t["useId".toString()] || (() => void 0);
var count$1 = 0;
...
const SheetContent = reactExports.forwardRef(
  ({ side = "right", className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetPortal, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Content$1, { ref, className: cn(sheetVariants({ side }), className), ...props, children: [
      children,
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Close, { className: "absolute right-6 top-6 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [
...
const SheetTitle = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { ref, className: cn("text-lg font-semibold text-foreground", className), ...props })
);
  ...
  if (isMobile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SheetContent,
      {
        ...
        side,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "sr-only", children: "Sidebar Navigation" }),
...
const SidebarSeparator = reactExports.forwardRef(
  ({ className, ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Separator$1, { ref, "data-sidebar": "separator", className: cn("mx-2 w-auto bg-sidebar-border", className), ...props });
  }
);
...
function AppContent({ variant = "header", children, ...props }) {
  if (variant === "sidebar") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarInset, { className: "bg-[#020408] relative overflow-hidden flex flex-col", ...props, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(14,165,233,0.08)_0%,transparent_50%)] pointer-events-none z-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-[0.02] pointer-events-none mix-blend-overlay z-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex flex-col flex-1", children })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mx-auto flex h-full w-full max-w-7xl flex-1 flex-col gap-4 rounded-xl", ...props, children });
}
function AppShell({ children, variant = "header" }) {
  const [isOpen, setIsOpen] = reactExports.useState(() => typeof window !== "undefined" ? localStorage.getItem("sidebar") !== "false" : true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { defaultOpen: isOpen, open: isOpen, onOpenChange: handleSidebarChange, children });
}
function Icon({ iconNode: IconComponent, className, ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(IconComponent, { className: cn("h-4 w-4", className), ...props });
}
function NavFooter({
  items,
  className,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroup, { ...props, className: `group-data-[collapsible=icon]:p-0 ${className || ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    SidebarMenuButton,
    {
      asChild: true,
      className: "text-neutral-600 hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-neutral-100",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: item.url, target: "_blank", rel: "noopener noreferrer", children: [
        item.icon && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { iconNode: item.icon, className: "h-5 w-5" }),
...
function NavMain({ items = [] }) {
  const page = K();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { className: "px-2 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { className: "text-[10px] font-black uppercase tracking-widest text-neutral-500 mb-2 px-3", children: "Comando Central" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SidebarMenuButton,
      {
        asChild: true,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs($e, { href: item.url, prefetch: true, className: "flex items-center gap-3", children: [
          item.icon && /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: `size-4 transition-colors ${item.url === page.url ? "text-sky-400" : "text-neutral-500 group-hover/nav:text-sky-300"}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-black uppercase tracking-[0.2em] text-[10px] transition-colors ${item.url === page.url ? "text-white" : "text-neutral-500 group-hover/nav:text-neutral-100"}`, children: item.title }),
          item.url === page.url && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 w-1 h-1/2 bg-sky-500 rounded-r-full shadow-[0_0_8px_rgba(14,165,233,0.8)]" })
        ] })
      }
    ) }, item.title)) })
  ] });
...
const Avatar = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(Root, { ref, className: cn("relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full", className), ...props })
);
Avatar.displayName = Root.displayName;
const AvatarImage = reactExports.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { ref, className: cn("aspect-square h-full w-full", className), ...props })
);
...
function UserInfo({ user, showEmail = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "h-8 w-8 overflow-hidden rounded-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "rounded-lg bg-neutral-200 text-black dark:bg-neutral-700 dark:text-white", children: getInitials(user.name || user.username) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid flex-1 text-left text-sm leading-tight", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate font-medium", children: user.name || user.username }),
      showEmail && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground truncate text-xs", children: user.email })
    ] })
  ] });
}
...
function UserMenuContent({ user }) {
  ...
  if (!user) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { className: "p-0 font-normal", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 px-1 py-1.5 text-left text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserInfo, { user, showEmail: true }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuGroup, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs($e, { className: "block w-full", href: route("profile.edit"), as: "button", prefetch: true, onClick: cleanup, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "mr-2" }),
      "Settings"
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs($e, { className: "block w-full", method: "post", href: route("logout"), as: "button", onClick: cleanup, children: [
...
function NavUser() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarMenuButton, { size: "lg", className: "sidebar-tactical-item text-sidebar-accent-foreground data-[state=open]:bg-sidebar-accent group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UserInfo, { user: auth == null ? void 0 : auth.user }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronsUpDown, { className: "ml-auto size-4 text-neutral-500 group-hover:text-white" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      DropdownMenuContent,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserMenuContent, { user: auth == null ? void 0 : auth.user })
      }
    )
  ] }) }) });
}
function AppLogo() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-1 py-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sky-500 flex aspect-square size-10 items-center justify-center transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppLogoIcon, { className: "size-8 fill-current drop-shadow-[0_0_12px_rgba(14,165,233,0.6)]" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center border-l border-white/10 pl-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[15px] font-black truncate leading-none uppercase tracking-tighter text-white", children: "GUERRAS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 bg-sky-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(14,165,233,0.8)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] truncate font-black uppercase tracking-[0.35em] text-sky-500", children: "MODERNAS" })
      ] })
    ] })
  ] });
}
...
function AppSidebar() {
  const changeMode = (mode) => {
    ...
    (_a = window.eventBus) == null ? void 0 : _a.emit("GAME:CHANGE_MODE", {
      timestamp: Date.now(),
      data: { mode }
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", variant: "inset", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarHeader, { className: "border-b border-white/5 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { size: "lg", asChild: true, className: "hover:bg-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { href: "/dashboard", prefetch: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppLogo, {}) }) }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[8px] font-black uppercase tracking-[0.3em] text-neutral-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SYSTEM_STATUS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-500", children: "OPERATIONAL" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [1, 1, 1, 1, 0.4].map((op, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[2px] flex-1 bg-sky-500", style: { opacity: op } }, i)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarContent, { className: "px-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavMain, { items: mainNavItems }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { className: "py-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroupLabel, { className: "text-[9px] font-black uppercase tracking-[0.5em] text-sky-500/60 mb-4 px-4 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1 h-1 bg-sky-500 rounded-full shadow-[0_0_8px_rgba(14,165,233,0.8)]" }),
          "COMMAND_PROTOCOLS"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 bg-black/40 p-2 rounded-2xl border border-white/5 shadow-inner mx-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(House, { size: 16, className: "text-sky-500/80 group-hover/btn:text-sky-400 transition-colors" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-black uppercase tracking-[0.2em] text-neutral-600 group-hover:text-neutral-400 transition-colors", children: "LOCAL_OPS" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: "flex-1 py-4 rounded-xl flex flex-col items-center justify-center gap-2 group/btn transition-all border border-transparent hover:bg-white/[0.03] hover:border-white/10 active:scale-95",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Map$1, { size: 16, className: "text-sky-500/80 group-hover/btn:text-sky-400 transition-colors" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-black uppercase tracking-[0.2em] text-neutral-600 group-hover:text-neutral-400 transition-colors", children: "WORLD_NET" })
              ]
            }
          )
        ] }) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarFooter, { className: "border-t border-white/5 bg-black/20 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavFooter, { items: footerNavItems, className: "mt-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavUser, {}) })
    ] })
  ] });
}
...
const BreadcrumbList = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { ref, className: cn("flex flex-wrap items-center gap-1.5 break-words text-sm text-muted-foreground sm:gap-2.5", className), ...props }));
BreadcrumbList.displayName = "BreadcrumbList";
const BreadcrumbItem = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { ref, className: cn("inline-flex items-center gap-1.5", className), ...props }));
BreadcrumbItem.displayName = "BreadcrumbItem";
const BreadcrumbLink = reactExports.forwardRef(({ asChild, className, ...props }, ref) => {
  const Comp = asChild ? Slot : "a";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Comp, { ref, className: cn("transition-colors hover:text-foreground", className), ...props });
});
BreadcrumbLink.displayName = "BreadcrumbLink";
const BreadcrumbPage = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { ref, role: "link", "aria-disabled": "true", "aria-current": "page", className: cn("font-normal text-foreground", className), ...props }));
BreadcrumbPage.displayName = "BreadcrumbPage";
const BreadcrumbSeparator = ({ children, className, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { role: "presentation", "aria-hidden": "true", className: cn("[&>svg]:h-3.5 [&>svg]:w-3.5", className), ...props, children: children ?? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, {}) });
BreadcrumbSeparator.displayName = "BreadcrumbSeparator";
function Breadcrumbs({ breadcrumbs }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: breadcrumbs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Breadcrumb, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BreadcrumbList, { children: breadcrumbs.map((item, index2) => {
    const isLast = index2 === breadcrumbs.length - 1;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BreadcrumbItem, { children: isLast ? /* @__PURE__ */ jsxRuntimeExports.jsx(BreadcrumbPage, { children: item.title }) : /* @__PURE__ */ jsxRuntimeExports.jsx(BreadcrumbLink, { href: item.href, children: item.title }) }),
...
function AppSidebarLayout({ children, breadcrumbs = [] }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppShell, { variant: "sidebar", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tactical-vignette" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppSidebar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AppContent, { variant: "sidebar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppSidebarHeader, { breadcrumbs }),
      children
    ] })
  ] });
}
const AppLayout = ({ children, breadcrumbs, ...props }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(AppSidebarLayout, { breadcrumbs, ...props, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(FlashListener, {}),
  children
] });
export {
  AppLayout as A,
...
//# sourceMappingURL=app-layout-tIk4CNjk.js.map
