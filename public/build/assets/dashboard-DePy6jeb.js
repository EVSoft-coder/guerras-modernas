...
import { i as isEasingArray, V as VisualElement, b as createBox, d as resolveElements, e as mixNumber, f as removeItem, g as isMotionValue, h as defaultOffset, k as createGeneratorEasing, l as fillOffset, n as isGenerator, s as secondsToMilliseconds, p as progress, o as isSVGElement, q as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, u as animateTarget, w as motionValue, x as spring, c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, m as motion, A as AnimatePresence, T as TriangleAlert, X, I as Info, y as Sr, U, a as me, z as axios, B as useToasts, C as eventBus, E as Events, L as Le } from "./app--rxgpRty.js";
import { T as Target, C as ChevronRight, M as Map$1, a as TooltipProvider, b as Tooltip, c as TooltipTrigger, H as House, d as TooltipContent, A as AppLayout } from "./app-layout-Bm9IupYV.js";
import { S as Shield } from "./shield-DZ_x2I8g.js";
import { U as Users } from "./users-BRsgeHix.js";
import { D as Dialog, a as DialogContent, b as DialogDescription, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-Dk_duVfD.js";
import { B as Button } from "./app-logo-icon-DSwN9vpj.js";
import { B as Badge, C as Clock, a as Crosshair, S as Search, A as AttackModal } from "./AttackModal-ceV8MDa6.js";
import { L as LoaderCircle } from "./loader-circle-BRThsAWa.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-u4SDK7bW.js";
import { I as Input } from "./index-DrEx3zkq.js";
import { g as gameStateService } from "./GameStateService-DPSDQ_EB.js";
import { S as Sword } from "./sword-Cl5hY0EJ.js";
import "./index-j8FxQyzH.js";
...
const VillageView = ({ base, onBuildingClick, gameConfig }) => {
  ...
  const buildings = GLOBAL_BUILDINGS.filter((b) => b.type !== "qg").map((b) => {
    const existing = (base.edificios || []).find((eb) => {
      var _a;
      return ((_a = eb.tipo) == null ? void 0 : _a.toLowerCase()) === b.type.toLowerCase();
    });
    const tipo = b.type.toLowerCase();
    const isLocked = b.requiredLevel && base.qg_nivel < b.requiredLevel;
    const level = existing ? existing.nivel : 0;
    return {
      ...b,
      id: existing == null ? void 0 : existing.id,
      level,
      tipo,
      nome: isLocked ? `[BLOQUEADO] LVL ${b.requiredLevel}` : `${b.nome} (Nível ${level})`,
...
//# sourceMappingURL=dashboard-DePy6jeb.js.map
