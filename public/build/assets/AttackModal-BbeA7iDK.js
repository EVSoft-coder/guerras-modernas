import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, Z as Zap, a as motion } from "./app-gV1bLVuy.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog--HZJC9fg.js";
import { c as cn, b as cva, B as Button } from "./app-logo-icon-CcfyCFoT.js";
...
import { C as ChevronRight } from "./app-layout-Ch0Y7mF3.js";
/**
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 border-r border-white/5 space-y-4 max-h-[450px] overflow-y-auto custom-scrollbar bg-white/[0.02]", children: [
        ...
        tropasDisponiveis.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-8 text-center border border-dashed border-white/10 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-neutral-600 uppercase", children: "Guarnição Vazia" }) }) : tropasDisponiveis.map((tropa) => {
          var _a, _b;
          const utId = tropa.unit_type_id || tropa.type_id || ((_a = unitTypes == null ? void 0 : unitTypes.find((u) => u.name === tropa.tipo || u.name === tropa.unidade)) == null ? void 0 : _a.id);
          if (!utId) return null;
...
//# sourceMappingURL=AttackModal-BbeA7iDK.js.map
