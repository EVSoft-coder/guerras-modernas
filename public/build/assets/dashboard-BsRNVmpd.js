import { i as isEasingArray, V as VisualElement, a as createBox, b as resolveElements, d as mixNumber, e as removeItem, f as isMotionValue, g as defaultOffset, h as createGeneratorEasing, k as fillOffset, l as isGenerator, s as secondsToMilliseconds, p as progress, n as isSVGElement, o as isSVGSVGElement, q as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, t as animateSingleValue, w as animateTarget, x as motionValue, y as spring, c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, r as reactExports, z as motion, U, X, A as AnimatePresence, S as Sr, B as eventBus, E as Events, u as useToasts, C as Logger, L as Le, $ as $e } from "./app-DVhCW0hA.js";
import { C as ChevronRight, T as TooltipProvider, A as AppLayout } from "./app-layout-BDG2cE_h.js";
import { S as Shield, T as Target } from "./target-CAvgcvAt.js";
import { U as Users } from "./users-fFZiFFyP.js";
import { D as Dialog, a as DialogContent, b as DialogTitle, c as DialogFooter } from "./dialog-CZaTCdss.js";
import { B as Button, c as cn } from "./app-logo-icon-m9kGpDHn.js";
import { B as Badge, C as Clock, a as ChevronUp, b as ChevronDown, A as AttackModal } from "./AttackModal-Di6ttb3h.js";
import { L as LoaderCircle } from "./loader-circle-D61u8krD.js";
import { I as Input } from "./index-DYdWR_ac.js";
import { g as gameStateService } from "./GameStateService-CNeKViQT.js";
import { S as Search } from "./search-z8n7pB29.js";
import { C as ChevronLeft } from "./chevron-left-SotA4uzb.js";
import { S as Sword } from "./sword-DKoR2HPg.js";
import { C as Crosshair } from "./crosshair-CnUSSxXn.js";
import { G as Globe, B as Book } from "./globe-BZmKQ4De.js";
import { r as resourceSystem } from "./ResourceSystem-DSD3qwFW.js";
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0, zIndex: 10, pointerEvents: "none" }, children: Object.entries(BUILDING_LAYOUT).map(([type, layout]) => {
            var _a, _b;
            const b = (_a = base.edificios) == null ? void 0 : _a.find(
              (e) => {
                var _a2;
                return ((_a2 = e.buildingType || e.tipo) == null ? void 0 : _a2.toLowerCase()) === type.toLowerCase() && e.pos_x === layout.x && e.pos_y === layout.y;
              }
            );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-6 min-h-[150px] relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10", children: [
        (tropas || []).map((t, idx) => {
          ...
          const displayName = config.name || rawUnitName.replace(/_/g, " ").replace(/-/g, " ").replace(/\b\w/g, (l) => l.toUpperCase());
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase text-white tracking-widest truncate", children: displayName }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          GarrisonPanel,
          {
            tropas: (units.length > 0 ? units : (base == null ? void 0 : base.tropas) || []).map((u) => {
              const unitType = u.type || unitTypes.find((ut) => ut.id === u.unit_type_id);
              return {
                tipo: (unitType == null ? void 0 : unitType.name) || u.unidade || u.tipo || "unidade",
...
//# sourceMappingURL=dashboard-BsRNVmpd.js.map
