import { i as isEasingArray, V as VisualElement, a as createBox, b as resolveElements, d as mixNumber, e as removeItem, f as isMotionValue, g as defaultOffset, h as createGeneratorEasing, k as fillOffset, l as isGenerator, s as secondsToMilliseconds, p as progress, n as isSVGElement, o as isSVGSVGElement, S as SVGVisualElement, H as HTMLVisualElement, v as visualElementStore, q as animateSingleValue, t as animateTarget, u as motionValue, w as spring, c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, r as reactExports, x as motion, X, A as AnimatePresence, y as Sr, U, z as eventBus, E as Events, B as useToasts, C as Logger, L as Le } from "./app-BjALQbpe.js";
import { T as Target, C as ChevronRight, a as TooltipProvider, A as AppLayout } from "./app-layout-CvoXbxlT.js";
import { S as Shield } from "./shield-BcZyGOBA.js";
import { U as Users } from "./users-B3tCPrKn.js";
import { D as Dialog, a as DialogContent, b as DialogTitle, c as DialogFooter } from "./dialog-CkKMl1FR.js";
import { B as Button } from "./app-logo-icon-DpU1jp93.js";
import { B as Badge, C as Clock, a as ChevronUp, b as ChevronDown, S as Search, A as AttackModal } from "./AttackModal-BoqR8zmT.js";
import { L as LoaderCircle } from "./loader-circle-ZcZS1XXM.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-igSl919Y.js";
import { I as Input } from "./index-DtJQ2Zti.js";
import { g as gameStateService } from "./GameStateService-BTf7wyzk.js";
import { C as ChevronLeft } from "./chevron-left-CNM1mGR2.js";
import { S as Sword } from "./sword-DNFk-KSp.js";
import { r as resourceSystem } from "./ResourceSystem-DRYHWNBR.js";
...
const Boxes = createLucideIcon("Boxes", __iconNode$9);
/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-60", children: type.replace(/_/g, " ") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-cyan-400", children: [
            "LVL ",
            level
          ] }),
          isConstructing && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 animate-pulse text-yellow-400", children: "🔨" })
        ] })
      ]
    }
  );
...
const VisualVillageView = ({ base, onBuildingClick, gameConfig, buildingQueue }) => {
  const getBuildingLevel = (type) => {
    ...
    const b = (_a = base.edificios) == null ? void 0 : _a.find((e) => {
      var _a2;
      return ((_a2 = e.buildingType || e.tipo) == null ? void 0 : _a2.toLowerCase()) === type.toLowerCase();
    });
    return (b == null ? void 0 : b.nivel) || 0;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-col items-center py-12 bg-[#050608]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", inset: 0, zIndex: 10, pointerEvents: "none" }, children: Object.entries(BUILDING_LAYOUT).map(([type, layout]) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              BuildingNode,
              {
                ...
                layout,
                isConstructing,
                onClick: () => onBuildingClick({ id: type, buildingType: type, name: (config == null ? void 0 : config.name) || type, level })
              },
              type
            );
          }) })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 py-0.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono font-black text-emerald-400", children: t.quantidade.toLocaleString() }) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
...
function VillageDashboard({
  ...
  if (selectedBuildingType) {
    ...
    const dbLevel = selectedBuildingType === "hq" ? Number(base.qg_nivel) : selectedBuildingType === "muralha" ? Number(base.muralha_nivel) : (foundBuilding == null ? void 0 : foundBuilding.nivel) || 0;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 flex-1 relative z-10", children: [
        ...
        gameMode === "WORLD_MAP" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          WorldMapView,
          {
            ...
            troops: units.length > 0 ? units.map((u) => {
              var _a;
              return { tipo: (_a = u.type) == null ? void 0 : _a.name, quantidade: u.quantity };
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-4 flex flex-col gap-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          GarrisonPanel,
          {
            tropas: units.length > 0 ? units.map((u) => {
              var _a;
              return { tipo: (_a = u.type) == null ? void 0 : _a.name, quantidade: u.quantity };
            }) : ((base == null ? void 0 : base.tropas) || []).map((t) => ({ tipo: t.unidade || t.tipo, quantidade: t.quantidade })),
            gameConfig
          }
        ),
...
function Dashboard(props) {
  ...
  state.units ?? props.units ?? [];
  state.movements ?? props.movements ?? [];
  if (gameMode === "WORLD_MAP") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(AppLayout, { breadcrumbs, children: [
      ...
      state.base && /* @__PURE__ */ jsxRuntimeExports.jsx(
        WorldMapView,
        {
          playerBase: currentBase,
          troops: state.units ? state.units.map((u) => {
            var _a2;
            return { unidade: (_a2 = u.type) == null ? void 0 : _a2.name, quantidade: u.quantity };
          }) : [],
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { breadcrumbs, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    VillageDashboard,
    {
      ...state,
      base: currentBase,
...
//# sourceMappingURL=dashboard-CJaG8o8s.js.map
