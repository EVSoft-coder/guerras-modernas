                    ...
                    <SidebarMenuItem key={item.title}>
                        ...
                        >
                            <Link href={item.url} prefetch>
                                ...
                                <span className={`font-black uppercase tracking-widest text-[11px] transition-colors ${item.url === page.url ? 'text-white' : 'text-neutral-100 group-hover/nav:text-white'}`}>{item.title}</span>
                            </Link>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                ))}
