...
export const VisualVillageView: React.FC<VillageViewProps> = ({ base, onBuildingClick, gameConfig, buildingQueue }) => {
    ...
    const saveCalibration = () => {
        console.log("=== NOVO BUILDING_OFFSETS VALIDAÇÃO V22 ===");
        console.log(JSON.stringify(offsets, null, 4));
        alert("Configuração V22 gerada na Console. Envia para o Antigravity!");
    };
    ...
    return (
        <div className="w-full flex flex-col items-center py-8 bg-[#050608]">
            {/* PAINEL DE CONTROLO DE CALIBRAÇÃO V91 */}
            <div className="mb-4 flex gap-4 z-[9999]">
                ...
                >
                    {isCalibrationMode ? '🟡 MODO DRAG ATIVO (V22)' : '🔘 RE-CALIBRAR PARA NOVO TERRENO'}
                </button>
                {isCalibrationMode && (
                    <button 
