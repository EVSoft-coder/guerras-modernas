...
/**
 * BuildingNode V89 — MASTERPIECE FINAL
 * Renderização isométrica determinística com offsets persistidos.
 */
export const BuildingNode: React.FC<BuildingNodeProps> = ({ 
    ...
    // Recuperamos o offset do BUILDING_OFFSETS (V89 VALIDAÇÃO MANUAL)
