...
export const BuildingNode: React.FC<BuildingNodeProps> = ({ tipo, nome, nivel, isConstructing, onClick }) => {
    ...
    return (
        ...
        >
            {/* Imagem do EdifÃ­cio com Brilho TÃ¡tico */}
            <div className="relative">
                ...
                >
                    <img 
                        ...
                        onError={() => {
                            ...
                            if (currentTryLevel > 1) {
                                setCurrentTryLevel(1); // Salta direto para o Lvl 1 se o intermÃ©dio falhar
                            } else {
                    ...
                    {/* Badge de NÃ­vel Tactical - POSICIONAMENTO INFERIOR V50 */}
