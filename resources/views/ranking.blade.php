        ...
        <div class="col-md-10">
            ...
            <div class="mt-4 p-4 rounded-4 bg-info/5 border border-info/20">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="text-info mb-1 fw-bold text-uppercase small">C�lculo de Prest�gio</h6>
                        <p class="text-muted small mb-0">Os pontos são calculados com base em: 1 ponto por cada nível de edifício em todas as tuas bases + b�nus de 10 pontos por base controlada.</p>
                    </div>
                </div>
            </div>
        </div>
